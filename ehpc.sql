...
# Database: ehpc
# Generation Time: 2017-04-14 08:38:04 +0000
# ************************************************************
...
INSERT INTO `programs` (`id`, `title`, `detail`, `difficulty`, `acceptedNum`, `submitNum`, `createdTime`, `user_id`, `default_code`)
VALUES
	(1,'编写Pthreads程序','编写Pthreads程序，求小于2n的素数。\r\n\r\na)	输入：整数n，10\\<n\\<48。\r\n\r\nb)	输出：二进制文件。每个素数用一个int64_t型的整数表示，找到的全部素数按照从小到大顺序存储在输出文件中。\r\n',0,0,0,'2016-12-29 23:53:11',3,'#include <stdio.h>\r\nint main(){\r\n    printf(\"\\n\");\r\n}'),
...
VALUES
	...
	(161,1,3,'#include <stdio.h>\r\nint main(){\r\n    printf(\"\\n\");\r\n}','mpi','2017-04-14 16:32:07',NULL);
...
VALUES
	...
	(3,'teacher','pbkdf2:sha1:1000$ZRqJzJuR$ec4e50db6eb3eaae92e7cb8bd9468fd2743c3505','teacher@qq.com','张三丰',0,'13800138000','中山大学','150101102',0,'2017-04-14 16:30:44','2016-09-29 03:36:08','http://sdcs.sysu.edu.cn','3.png?t=1489327909.05',2,'混吃等死不舒服',0,4,6,NULL),
