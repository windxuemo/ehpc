...
# Database: ehpc
# Generation Time: 2017-03-15 13:24:52 +0000
# ************************************************************
...
VALUES
	(4,'并行编程入门','本内容以并行计算为主题，由并行结构、并行算法、并行编程及并行算法实例四部分内容构成，强调并行结构、并行算法、并行程序设计的有机联系，从基础、算法实例、算法分析、算法实现以及应用各个角度介绍了并行计算的基本技术。',20,'2016-12-21 00:00:00'),
...
VALUES
	...
	(17,'CUDA编程','CUDA(Compute Unified Device Architecture)，是显卡厂商NVIDIA推出的运算平台。','CUDA(Compute Unified Device Architecture)，是显卡厂商NVIDIA推出的运算平台。 CUDA™是一种由NVIDIA推出的通用并行计算架构，该架构使GPU能够解决复杂的计算问题。 它包含了CUDA指令集架构（ISA）以及GPU内部的并行计算引擎。 开发人员现在可以使用C语言来为CUDA™架构编写程序，C语言是应用最广泛的一种高级编程语言。所编写出的程序于是就可以在支持CUDA™的处理器上以超高性能运行。','2017-03-13 17:39:06',1,1,'upload/course/cover_17.png',NULL,NULL,0.00,0,'2017-03-13 17:45:41','2017-06-29 17:45:30',3);
...
VALUES
	(4,'algo-quicksheet.pdf',3,3,'course_1/homework_3/0_name_algo-quicksheet.pdf','2017-03-12 20:45:02'),
	(5,'nahan.key.zip',4,3,'course_1/homework_4/0_name_nahan.key.zip','2017-03-12 20:47:56'),
	(6,'icde2016-keynote-brasche-huawei.pdf',3,3,'course_1/homework_3/150101102_张三丰_icde2016-keynote-brasche-huawei.pdf','2017-03-15 13:57:53');
...
VALUES
	...
	(245,'CUDA PPT','http://www.cs.kent.edu/~zhao/gpu/lectures/cuda.ppt',140,'video');
...
VALUES
	...
	(3,5,0,'2017-03-15 13:30:15'),
	(3,6,0,'2017-03-13 15:47:37'),
	(5,5,0,'2017-03-03 13:34:55'),
	(10,5,0,'2017-03-09 09:37:20'),
...
VALUES
	...
	(9,'test','测试',11,0,2,7,'2016-11-07 10:43:47','2016-11-07 18:43:47'),
...
VALUES
	(1,'root','pbkdf2:sha1:1000$xBnOyGu0$2265b81c262f0438d80348748b24db1f66a65425','1291023320@qq.com','name',1,'13800138000','university','0',1,'2017-03-14 16:19:07','2016-09-29 03:14:30','','1.png?t=1475844478.0',1,'知其然，知其所以然。知识广度是深度的副产品！',5,1,3,NULL),
	...
	(3,'teacher','pbkdf2:sha1:1000$ZRqJzJuR$ec4e50db6eb3eaae92e7cb8bd9468fd2743c3505','teacher@qq.com','张三丰',0,'13800138000','中山大学','150101102',0,'2017-03-15 15:26:12','2016-09-29 03:36:08','http://sdcs.sysu.edu.cn','3.png?t=1489327909.05',2,'混吃等死不舒服',0,3,6,NULL),
	...
	(5,'admin','pbkdf2:sha1:1000$h9IWWCJh$78e5c725ab15124732c7b19dbe43775df4e823e1','admin@qq.com','name',1,'13800138000','university','0',0,'2017-03-14 16:05:42','2016-10-22 11:41:15',NULL,'none.jpg',0,NULL,0,0,0,NULL),
	...
	(10,'Zouzhp','pbkdf2:sha1:1000$fzjFGAmb$30667cca608819c147c04d5a49671989dd66cefd','503951764@qq.com','name',1,'13800138000','university','0',1,'2017-03-09 18:58:22','2016-12-12 10:22:07',NULL,'10.png?t=1481509362.88',1,NULL,0,0,0,NULL),
	...
	(13,'111','pbkdf2:sha1:1000$DaD5XWyO$c00d0caab874bac4e3ef1328bdcfc0408a5974b9','1970025901@qq.com','name',1,'13800138000','university','0',1,'2017-03-13 20:39:25','2017-01-09 18:47:36',NULL,'none.jpg',1,NULL,0,0,0,NULL),
