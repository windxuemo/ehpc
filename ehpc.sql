...
INSERT INTO `alembic_version` VALUES ('5fca788121a0');
...
INSERT INTO `cases` VALUES ('2', '案例2', '案例2描述', 'test;case');
INSERT INTO `cases` VALUES ('3', '案例3', '案例3描述', 'test;case');
INSERT INTO `cases` VALUES ('4', '案例4', '案例4描述', 'test;case');
INSERT INTO `cases` VALUES ('5', '案例5', '案例5描述', 'test;case');
INSERT INTO `cases` VALUES ('6', '案例6', '案例6描述', 'test;case');
INSERT INTO `cases` VALUES ('7', '案例7', '案例7描述', 'test;case');
INSERT INTO `cases` VALUES ('8', '案例8', '案例8描述', 'test;case');

-- ----------------------------
-- Table structure for case_codes
-- ----------------------------
...
CREATE TABLE `case_code_materials` (
  ...
  PRIMARY KEY (`id`),
  KEY `version_id` (`version_id`),
  KEY `case_code_materials_ibfk_2` (`case_id`),
  CONSTRAINT `case_code_materials_ibfk_1` FOREIGN KEY (`version_id`) REFERENCES `case_codes` (`version_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `case_code_materials_ibfk_2` FOREIGN KEY (`case_id`) REFERENCES `cases` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=68 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- ----------------------------
-- Records of case_code_materials
-- ----------------------------
INSERT INTO `case_code_materials` VALUES ('66', 'fileinput.js', 'case/1/version_1/fileinput.js', '1', '1');
INSERT INTO `case_code_materials` VALUES ('67', 'fileinput.min.js', 'case/1/version_1/fileinput.min.js', '1', '1');
...
INSERT INTO `course_users` VALUES (1,3),(1,2),(3,1),(2,1),(4,1),(7,1),(5,4),(1,7),(5,1);
...
INSERT INTO `groups` VALUES (1,'C++讨论','这里讨论 C++ 的基础知识，欢迎一起来讨论C++编程啊！','/static/upload/group_logo/1.png?t=1477277380.0',2,4,'2016-09-20 00:00:00'),(2,'意见反馈','反馈给站点的意见','/static/upload/group_logo/2.jpg',4,2,'2016-08-20 00:00:00'),(3,'学习交流','在这里交流学习的心得体会','/static/upload/group_logo/3.jpg',0,1,'2016-10-20 00:00:00'),(4,'使用指南','网站使用指南','/static/upload/group_logo/4.jpg',1,2,'2016-09-20 00:00:00'),(5,'课程推荐','优秀课程推荐','/static/upload/group_logo/5.jpg',0,0,'2016-10-10 00:00:00'),(6,'并行运算','并行运算课程群','/static/upload/group_logo/6.jpg',0,1,'2016-09-20 00:00:00'),(15,'测试群组','这是一个测试群组','/static/upload/group_logo/15.png?t=1477277568.0',2,1,'2016-10-24 10:52:49');
...
INSERT INTO `knowledges` VALUES (1,'并行计算','测试并行计算'),(2,'新的实验','测试新的实验');
...
INSERT INTO `paper_question` VALUES (1,1,20),(2,1,20),(3,1,20),(4,1,20),(5,1,20),(6,1,20),(7,1,20),(8,1,20);
...
INSERT INTO `question_classifies` VALUES (1,1),(1,2),(2,1),(2,2),(3,1),(4,1),(5,2),(6,3),(7,2),(8,1),(9,2),(10,1),(11,1),(12,1);
...
INSERT INTO `questions` VALUES (1,0,'{\"title\": \"选择题1\", \"len\": 4, \"0\": \"这是A\", \"1\": \"这是B\", \"2\": \"这是C\", \"3\": \"这是D\"}','A','解析1'),(2,1,'{\"title\": \"选择题2\", \"len\": 5, \"0\": \"这是A\", \"1\": \"这是B\", \"2\": \"这是C\", \"3\": \"这是D\", \"4\": \"这是E\"}','A;B;E','解析2'),(3,2,'{\"title\": \"选择题3\", \"len\": 4, \"0\": \"这是A\", \"1\": \"这是B\", \"2\": \"这是C\", \"3\": \"这是D\"}','A;B','解析3'),(4,3,'填*空*题1, 填*空*题2','{\"len\": 2, \"0\": \"答案1\", \"1\": \"答案2\"}','解析4'),(5,4,'判断题1','0','解析5'),(6,5,'问答题1','问答题答案','解析6'),(7,0,'{\"title\": \"选择题5\", \"len\": 4, \"0\": \"这是A\", \"1\": \"这是B\", \"2\": \"这是C\", \"3\": \"这是D\"}','A','解析7'),(8,0,'{\"title\": \"选择题6\", \"len\": 4, \"0\": \"这是A\", \"1\": \"这是B\", \"2\": \"这是C\", \"3\": \"这是D\"}','A','解析8'),(9,4,'12','0','111'),(10,5,'问答题测试','新的问答题','这是测试'),(11,3,'填空题目 * * ，答案','{\"0\":\" \",\"len\":1}','答案是多少'),(12,4,'新的判断题目','0','因为错了');
