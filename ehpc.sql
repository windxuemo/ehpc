...
VALUES
	(4,'并行编程入门','本内容以并行计算为主题，由并行结构、并行算法、并行编程及并行算法实例四部分内容构成，强调并行结构、并行算法、并行程序设计的有机联系，从基础、算法实例、算法分析、算法实现以及应用各个角度介绍了并行计算的基本技术。',3);
...
CREATE TABLE `qrcode` (
  ...
  PRIMARY KEY (`id`),
  KEY `course_id` (`course_id`),
  CONSTRAINT `qrcode_ibfk_1` FOREIGN KEY (`course_id`) REFERENCES `courses` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
