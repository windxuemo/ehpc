...
# Database: ehpc
# Generation Time: 2017-03-19 11:14:23 +0000
# ************************************************************
...
VALUES
	...
	(10,5,'ads','2017-03-13 09:44:40',15,3);
...
VALUES
	...
	(8,'HW1','Test','2017-03-16 09:32:45','2017-03-31 09:30:18',17),
	(9,'HW2','Test','2017-03-16 10:34:38','2017-04-28 10:30:23',17),
	(11,'HW1','HW11','2017-03-17 23:13:24','2017-03-31 23:10:52',15);
...
VALUES
	...
	(48,'[2]-FGCS17.pdf',8,3,'course_17/homework_8/appendix_48.pdf','2017-03-16 09:32:45'),
	(49,'LSTM_Tutorial.pdf',8,3,'course_17/homework_8/appendix_49.pdf','2017-03-16 09:37:13'),
	(50,'memory_networks.pdf',8,3,'course_17/homework_8/appendix_50.pdf','2017-03-16 09:37:34'),
	(51,'appendix_48.pdf',9,3,'course_17/homework_9/appendix_51.pdf','2017-03-16 10:34:38'),
	(53,'KMP_Algorithm.pdf',11,3,'course_15/homework_11/appendix_53.pdf','2017-03-17 23:13:24');
...
VALUES
	...
	(9,'222.200.182.65.zip',8,23,'course_17/homework_8/342342343_吴迪2_222.200.182.65.zip','2017-03-16 09:41:33'),
	(10,'appendix_48.pdf',8,23,'course_17/homework_8/342342343_吴迪2_appendix_48.pdf','2017-03-16 09:41:33'),
	(11,'KMP_Algorithm.pdf',8,23,'course_17/homework_8/342342343_吴迪2_KMP_Algorithm.pdf','2017-03-16 10:07:30'),
	(15,'222.200.182.65.zip',9,23,'course_17/homework_9/342342343_吴迪2_222.200.182.65.zip','2017-03-16 11:04:26'),
	(16,'Docker生态会重蹈Hadoop的覆辙吗？.pdf',8,23,'course_17/homework_8/342342343_吴迪2_Docker生态会重蹈Hadoop的覆辙吗？.pdf','2017-03-16 16:50:46'),
	(18,'appendix_48.pdf',11,3,'course_15/homework_11/150101102_张三丰_appendix_48.pdf','2017-03-17 23:14:14'),
	(20,'150101102_张三丰_algo-quicksheet.pdf',11,3,'course_15/homework_11/150101102_张三丰_150101102_张三丰_algo-quicksheet.pdf','2017-03-17 23:15:26');
...
INSERT INTO `knowledges` (`id`, `title`, `content`, `user_id`)
VALUES
	(5,'MPI 编程入门','MPI(Message Passing Interface)是一个跨语言的通讯协议,用于编写并行程序。与OpenMP并行程序不同，MPI是一种基于消息传递的并行编程技术。消息传递接口是一种编程接口标准，而不是一种具体的编程语言。\n简而言之，MPI标准定义了一组具有可移植性的编程接口。不同的厂商和组织遵循着这个标准推出各自的实现，而不同的实现也会有其不同的特点。\n由于MPI提供了统一的编程接口，程序员只需要设计好并行算法，使用相应的MPI库就可以实现基于消息传递的并行计算。MPI支持多种操作系统，包括大多数的类UNIX和Windows系统。',3),
	(6,'OpenMP 编程入门','OpenMP（Open Multi-Processing）是一套支持跨平台共享内存方式的多线程并发的编程API，使用C,C++和Fortran语言，可以在大多数的处理器体系和操作系统中运行，包括Solaris, AIX, HP-UX, GNU/Linux, Mac OS X, 和Microsoft Windows。包括一套编译器指令、库和一些能够影响运行行为的环境变量。\nOpenMP采用可移植的、可扩展的模型，为程序员提供了一个简单而灵活的开发平台，从标准桌面电脑到超级计算机的并行应用程序接口。',3);
...
VALUES
	...
	(139,15,'Memory Network','Memory Network',15),
	(143,17,'Lec 1','This is a lecture',17);
...
VALUES
	...
	(244,'memory_networks.pdf','course_15/lesson139_material244.pdf',139,'pdf'),
	(252,'KMP_Algorithm.pdf','course_17/lesson143_material252.pdf',143,'pdf'),
	(253,'Frontiers_in_Massive_Data_Analysis.pdf','course_17/lesson143_material253.pdf',143,'pdf'),
	(254,'Video','http://v.youku.com/v_show/id_XMjY0MTYxOTAxNg==.html',143,'video');
...
VALUES
	(1,5,0,'2017-03-10 20:31:08'),
	(1,6,0,'2017-03-10 20:31:19'),
	(3,5,0,'2017-03-17 14:50:36'),
	(3,6,0,'2017-03-16 12:02:48'),
	(5,5,0,'2017-03-03 13:34:55'),
	(10,5,0,'2017-03-19 15:53:30'),
	(13,5,0,'2017-03-13 20:39:32'),
	(15,5,0,'2017-03-05 14:05:23'),
...
VALUES
	(1,'2017-03-13 17:38:54',1),
	(2,'2017-03-17 23:25:23',15),
	(3,'2017-03-17 23:25:33',17);
...
VALUES
	(3,4,'choice','2017-03-13 15:49:36'),
...
VALUES
	(1,'root','pbkdf2:sha1:1000$xBnOyGu0$2265b81c262f0438d80348748b24db1f66a65425','1291023320@qq.com','name',1,'13800138000','university','0',1,'2017-03-19 09:07:10','2016-09-29 03:14:30','','1.png?t=1475844478.0',1,'知其然，知其所以然。知识广度是深度的副产品！',5,1,3,NULL),
	...
	(3,'teacher','pbkdf2:sha1:1000$ZRqJzJuR$ec4e50db6eb3eaae92e7cb8bd9468fd2743c3505','teacher@qq.com','张三丰',0,'13800138000','中山大学','150101102',0,'2017-03-19 13:33:52','2016-09-29 03:36:08','http://sdcs.sysu.edu.cn','3.png?t=1489327909.05',2,'混吃等死不舒服',0,4,6,NULL),
	...
	(5,'admin','pbkdf2:sha1:1000$h9IWWCJh$78e5c725ab15124732c7b19dbe43775df4e823e1','admin@qq.com','name',1,'13800138000','university','0',0,'2017-03-18 20:40:05','2016-10-22 11:41:15',NULL,'none.jpg',0,NULL,0,0,0,NULL),
	(6,'wudi','pbkdf2:sha1:1000$Qk7DY2fe$1a4a67c484525536c1abbe395bd8b5861d7ace37','wudi27@mail.sysu.edu.cn','name',1,'13800138000','university','0',1,'2016-10-18 11:13:55','2016-10-18 02:57:55',NULL,'none.jpg',1,NULL,1,1,0,NULL),
	...
	(13,'111','pbkdf2:sha1:1000$DaD5XWyO$c00d0caab874bac4e3ef1328bdcfc0408a5974b9','1970025901@qq.com','name',1,'13800138000','university','0',1,'2017-03-17 10:26:04','2017-01-09 18:47:36',NULL,'none.jpg',1,NULL,0,0,0,NULL),
	...
	(15,'dwu','pbkdf2:sha1:1000$7YoOrRPt$499036e5bc8a51f6813868f0ecc9153d0877f17a','wudi.cuhk@foxmail.com','name',1,'13800138000','university','0',1,'2017-03-05 14:20:37','2017-03-05 12:22:41',NULL,'15.png?t=1488690754.96',1,NULL,0,0,0,NULL),
	...
	(23,'diwu27','pbkdf2:sha1:1000$9ay4PIMO$0153bff0e08cbb28c0b2d4f715e9c6393c3dad23','wudi.cuhk@gmail.com','吴迪2',0,'12321323323','中山大学','342342343',1,'2017-03-16 16:48:18','2017-03-16 08:40:18',NULL,'none.jpg',1,NULL,0,0,0,NULL),
