...
# Database: ehpc
# Generation Time: 2017-01-04 05:46:19 +0000
# ************************************************************
...
VALUES
	(1,'C++讨论','这里讨论 C++ 的基础知识，欢迎一起来讨论C++编程啊！','/static/upload/group_logo/1.png?t=1481772698.14',2,4,'2016-09-20 00:00:00'),
	(2,'意见反馈','反馈给站点的意见','/static/upload/group_logo/2.jpg',4,2,'2016-08-20 00:00:00'),
	(3,'学习交流','在这里交流学习的心得体会','/static/upload/group_logo/3.jpg',0,1,'2016-10-20 00:00:00'),
	(4,'使用指南','网站使用指南','/static/upload/group_logo/4.jpg',1,2,'2016-09-20 00:00:00'),
	(5,'课程推荐','优秀课程推荐','/static/upload/group_logo/5.jpg',0,0,'2016-10-10 00:00:00'),
	(6,'并行运算','并行运算课程群','/static/upload/group_logo/6.jpg',0,1,'2016-09-20 00:00:00'),
...
VALUES
	(3,'作业1','将一种互连网络中的结点映射到另一种网络的过程叫做嵌入（Embedding）。研究嵌入是很重要的，因为设计在某一特定网络连接的并行机上的算法，如果实际运行在另一种与之不同的互连网络的并行机上时，我们要重新分析其通信（即选路）时间。试问：\r\n* 如何将一个环形网络嵌入到带环绕的二维网孔中去？\r\n* 被嵌入到带环绕的二维网孔上的原设计的算法其选路时间有何变化？\r\n','2016-12-25 15:45:01','2016-12-27 15:45:03',1),
	(4,'作业2','查阅资料，找出一个并行计算的典型应用，详细描述该应用在并行化方面成功和失败之处以及遇到的困难：（从下列方面考虑：该应用是针对什么科学或者工程上的具体问题设计的；对于要解决的问题，该应用实际效果怎样，模拟结果和物理结果进行比较的结果如何；该应用的运行在什么并行计算平台上；（比如分布式或共享内存，向量机）这个应用使用那种开发工具开发的；该应用的实际工作性能怎样，和运行平台最佳性能相比较；该应用的可扩展性如何？如果不好，你认为它的扩展性的瓶颈在何处？）','2016-12-25 15:45:29','2016-12-28 15:45:32',1);
...
VALUES
	(1,'ch1.pdf',3,3,'course_1/homework_3/ch1.pdf','2016-12-27 10:48:52'),
	(2,'ch2.pdf',3,3,'course_1/homework_3/ch2.pdf','2016-12-27 10:49:02');
...
INSERT INTO `knowledges` (`id`, `title`, `content`)
VALUES
	(4,'并行编程入门','本内容以并行计算为主题，由并行结构、并行算法、并行编程及并行算法实例四部分内容构成，强调并行结构、并行算法、并行程序设计的有机联系，从基础、算法实例、算法分析、算法实现以及应用各个角度介绍了并行计算的基本技术。');
...
VALUES
	...
	(144,'lect8.pdf','course_3/lesson18_material144.pdf',18,'pdf'),
	(145,'lect9.pdf','course_3/lesson19_material145.pdf',19,'pdf'),
	(146,'CS4230-L15.pdf','course_4/lesson37_material146.pdf',37,'pdf'),
...
INSERT INTO `programs` (`id`, `title`, `detail`, `difficulty`, `acceptedNum`, `submitNum`, `createdTime`)
VALUES
...
INSERT INTO `progress` (`user_id`, `knowledge_id`, `cur_progress`)
VALUES
	(1,4,1),
	(2,4,6),
	(3,2,0),
...
INSERT INTO `questions` (`id`, `type`, `content`, `solution`, `analysis`)
VALUES
	...
	(15,1,'{\"0\":\"计算密集型（Compute-Intensive）\",\"1\":\"数据密集型 (Data-Intensive)\",\"2\":\"文本密集型 (Text-Intensive)\",\"3\":\"网络密集型 (Network-Intensive)\",\"title\":\"并行计算的应用可概括为以下哪些方面\",\"len\":4}','A;B;D','科学与工程计算对并行计算的需求是十分广泛的，但所有的应用可概括为三个方面：\r\n\r\n* 计算密集型（Compute-Intensive）：这一类型的应用问题主要集中在大型科学工程计算与数值模拟（气象预报、地球物理勘探等）\r\n* 数据密集型 (Data-Intensive)：Internet的发展，为我们提供了大量的数据资源，但有效地利用这些资源，需要进行大量地处理，且对计算机的要求也相当高，这些应用包括数字图书馆、数据仓库、数据挖掘、计算可视化。\r\n* 网络密集型 (Network-Intensive)：通过网络进行远距离信息交互，来完成用传统方法不同的一些应用问题。如协同工作、遥控与远程医疗诊断等'),
	(16,4,'SIMD中通常包含大量处理单元PE，而控制部件只有一个。控制部件广播一条指令，所有的处理单元同时执行这条指令，但不同的处理单元操作的数据可能不同。','1','SIMD中通常包含大量处理单元PE，而控制部件只有一个。控制部件广播一条指令，所有的处理单元同时执行这条指令，但不同的处理单元操作的数据可能不同。'),
	(17,4,'并行向量处理机的最大特点是其中的各处理器完全平等，无主从之分。所有的处理器都可以访问任何存储单元和I/O设备。','0','对称多处理机 对称多处理机的最大特点是其中的各处理器完全平等，无主从之分。所有的处理器都可以访问任何存储单元和I/O设备。存储器一般使用共享存储器，只有一个地址空间。'),
	(18,4,'为了维持一定的并行效率（介于 0 与 1 之间），当处理器 P 增大时，需要相应地增大问题规模 W 的值，由此定 义函数 fE(p)为问题规模 W 随处理器 P 变化的函数，称此函数为等效率函数。','1',''),
	(19,4,'用户态线程和核心态线程都由操作系统直接调度。','0',''),
	(20,4,'在广播通信中，单个进程传递相同的数据给所有的进程。','1',''),
	(21,4,'while 循环语句是忙等待的一个例子。','1',''),
	(22,4,'一个好的并行算法要既能很好地匹配并行计算机硬件体系结构的特点又能反映问题内在并行性。','1',''),
	(23,4,'如果一个线程在临界区中执行代码，其他线程需要被排序在临界区外。','1',''),
	(24,4,'计算机视觉不属于英特尔集成性能函数库(IPP)所涵盖的领域。','0',''),
	(25,4,'控制单元负责决定应该执行程序中的哪些指令，而 ALU 负责执行指令核已经成为中央处理器或者 CPU 的代名词。','1',''),
	(26,4,'OpenMP 是用于共享内存并行系统的多线程程序设计的一套指导性的编译处理方案(Compiler Directive)，也可以将其扩展到用于分布式内存的集群系统。','1',''),
	(27,4,'在共享内存系统中，每个处理器有自己私有的内存空间，处理器-内存对之间通过互连网络相互通信。','0',''),
	(28,4,'在 Amdahl 定律中，以 f 表示串行分量的比例，随着处理器数目的无限增大，并行系统所能够达到的加速上限是S=1/f。','1',''),
	(29,4,'通过继续增快集成电路的速度来提高处理器性能是可行的。','0',''),
	(30,4,'阻塞通信的功能都可以用非阻塞通信的方式实现。','1',''),
	(31,4,'ALU 负责决定应该执行程序中的哪些指令，而控制单元负责执行指令。','0',''),
	(32,4,'OpenMP 对同一个临界区不应当混合使用不同的互斥机制。','1',''),
	(33,4,'MPI 中发送语句用整型，接收语句用实型可以匹配。','0',''),
	(34,4,'在有效编程下，超线程性能要高于多核性能。','0',''),
	(35,4,'MPI_COMM_RANK 是 MPI 的一个基本函数，它用于确定进程总数。','0',''),
	(36,4,'并行计算中的并行性指问题中具有可在同一时刻发生的两个或者多个运算或者操作的特性。','0',''),
	(37,4,'英特尔线程检查器能够找出线程间的工作不平衡。','0',''),
	(38,4,'如果 MPI 程序中的某条输出语句在每一个进程都执行，则从标准输出上看，不同进程对该语句的输出在 顺序上是随机的。','1',''),
	(39,4,'依赖于 MPI 提供的缓冲机制是安全的。','0',''),
	(40,4,'利用矩阵向量相乘的方式进行离散傅立叶变换，计算复杂度是 O(n3),而快速傅里叶变换的时间复杂度是 O(nlogn)。','0',''),
	(41,4,'对于一个给定的应用，并行算法相比于串行算法的性能提升是（1- T 并行执行时间/T 串行执行时间）','0',''),
	(42,4,'一般来说，对高速缓冲存储器的访问时间比其他存储区域的访问时间短','1',''),
	(43,4,'组通信需要该组内所有的进程都参加?。','1',''),
	(44,4,'在细粒度多线程中，处理器在每条指令执行完后切换线程，从而跳过被阻塞的线程。','1',''),
	(45,4,'英特尔 Parallel Inspector 采用动态技术，不需要特殊的检查工具或者编译','1',''),
	(46,4,'虚拟进程数要小于实际的处理器的个数。','0',''),
	(47,4,'Vtune 性能分析器能够分析程序中的代码错误并指出错误代码的位置。','0',''),
	(48,4,'Linpack 是国际上最流行的用于测试高性能计算机系统浮点性能的 benchmark。它采用高斯消元法求解一 元 N 次稠密线性代数方程组，也即采用正交三角分解法（LU 分解）。','0',''),
	(49,4,'在并行程序设计中，局部变量指的是单个函数的私有变量。','0',''),
	(50,4,'忙等待是保护临界区的唯一办法。','0',''),
	(51,4,'向量处理器与图形处理器单元一般划分在 SIMD 系统里。','1',''),
	(52,4,'如果一个线程在临界区中执行代码，其他线程需要被排序在临界区外。','1',''),
	(53,4,'单处理器性能大幅度提升的主要原因之一是日益增加的集成电路晶体管密度。','1',''),
	(54,4,'依赖于 MPI 提供的缓冲机制是安全的。','0',''),
	(55,4,'OS timer service 是 Vtune 性能分析器的基于时间的采样。','1',''),
	(56,4,'利用虚拟存储器，使得主存可以作为辅存的缓存。','1',''),
	(57,4,'在分布式内存系统中，各个核能够共享访问计算机的内存，理论上每个核能够读、写内存的所有','0',''),
	(58,4,'在实现指令级并行中，流水线是指将功能单元分阶段安排。（','0',''),
	(59,4,'Vtune 性能分析器不搜集执行代码在内存中的地址信息。','0',''),
	(60,4,'将串行程序并行化，并行化的代码区域越多，程序的整体性能越好。','0',''),
	(61,4,'多核 CPU 中也可以使用超线程技术。','1',''),
	(62,4,'在大多数系统中，进程间的切换比线程间的切换更快。','0',''),
	(63,4,'在共享内存系统中，每个处理器有自己私有的内存空间，处理器-内存对之间通过互连网络相互 通信。','0',''),
	(64,4,'英特尔线程检查器能够找出线程间的工作不平衡。','0',''),
	(65,4,'内存系统由多个内存“体”组成，每个内存体能够独立访问。','1',''),
	(66,4,'阻塞通信的功能都可以用非阻塞通信的方式实现?。','1',''),
	(67,4,'一个好的并行算法要既能很好地匹配并行计算机硬件体系结构的特点又能反映问题内在并行性','1',''),
	(68,4,'组通信调用只能实现通信功能 。','0',''),
	(69,4,'中央处理单元分为控制单元和算术逻辑单元。','1',''),
	(70,4,'在并行程序设计中，局部变量指的是单个函数的私有变量。','0',''),
	(71,4,'非阻塞通信的功能都可以用阻塞通信的方式实现?。','0',''),
	(72,4,'Cache 3C 失效中的强制性失效不受 Cache 容量的影响。','1',''),
	(73,4,'MPI 主从模式的并行程序可以为 SPMD 形式。','1',''),
	(74,4,'在实现指令级并行中，流水线是指将功能单元分阶段安排。','0',''),
	(75,4,'多线程程序中，一个线程可以与同进程中的其它线程共享数据，因此当一个线程对全局变量 X赋值 0（即执行 x=0）之后，其它线程立刻读取 X，其值必为 0。','0',''),
	(76,4,'在共享内存系统中，每个核拥有自己的私有内存，核之间的通信是显式的，必须使用类似于网络 中发送消息的机制。','0',''),
	(77,4,'不管 OpenMP 语句以何种形式实现，修改同一变量的不同语句都将视为属于同一个临界区。','1',''),
	(78,4,'在机群系统的并行应用中，一个进程先执行发送操作，另一个进程先执行相应的接收操作，是安 全的发送和接收序列。','1',''),
	(79,4,'将串行程序并行化，并行化的代码区域越多，程序的整体性能越好。','0',''),
	(80,4,'英特尔 Parallel Inspector 采用动态技术，不需要特殊的检查工具或者编译','1',''),
	(81,4,'IPO 对于循环内包含调用的程序可以极大地提高其性能。','1',''),
	(82,4,'操作系统是一种用来管理计算机的软件和硬件资源的主要软件。','1',''),
	(83,4,'单处理器性能大幅度提升的主要原因之一是日益增加的集成电路晶体管密度。','1',''),
	(84,4,'ALU 负责决定应该执行程序中的哪些指令，而控制单元负责执行指令。','0',''),
	(85,4,'在共享内存系统中，每个核拥有自己的私有内存，核之间的通信是显式的，必须使用类似于网络 中发送消息的机制。','0',''),
	(86,4,'MPI 使用的是所谓的“推”（Push） 通信机制','1',''),
	(87,4,'一块内存空间，包括可执行代码，一个用来跟踪执行函数的调用栈、一个堆，以及一些其他内存','1',''),
	(88,4,'一个并行程序的并行效率越高，它的浮点性能就越高。','0',''),
	(89,4,'MPI 中发送语句用整型，接收语句用实型可以匹配。','0',''),
	(90,4,'在大多数系统中，进程间的切换比线程间的切换更快。','0',''),
	(91,4,'操作系统是一种用来管理计算机的软件和硬件资源的主要软件。','1',''),
	(92,4,'有依赖关系的语句中一定有语句会有序地写或更新变量。','1',''),
	(93,4,'如果一个线程在临界区中执行代码，其他线程需要被排序在临界区外。','1',''),
	(94,4,'OpenMP 只能并行化 for 循环，不能并行化 while 和 do-while 循环。','1',''),
	(95,4,'内存系统由多个内存“体”组成，每个内存体能够独立访问。','1',''),
	(96,4,'用户态线程和核心态线程都由操作系统直接调度。','0',''),
	(97,4,'并行算法求解问题只要保证与相应的串行算法一致的数据依赖，则其求解的结果与串行算法相同。','0',''),
	(98,4,'依赖于 MPI 提供的缓冲机制是安全的。','0',''),
	(99,4,'一个并行程序的并行效率越高，它的浮点性能就越高。','0',''),
	(100,4,'向量处理器与图形处理器单元一般划分在 SIMD 系统里。','1',''),
	(101,4,'在并行程序设计中，局部变量指的是单个函数的私有变量。','0',''),
	(102,4,'依赖于 MPI 提供的缓冲机制是安全的。','0',''),
	(103,4,'大多数系统中，默认状态下，一个进程的内存块是公有的。','0',''),
	(104,4,'在分布式内存和共享内存系统，所有进程/线程都能够访问 stdout 和 stder','1',''),
	(105,4,'OS timer service 是 Vtune 性能分析器的基于时间的采样。','1',''),
	(106,4,'所有的向量数据类型都可以定义为结构数据类型。','1',''),
	(107,4,'内存系统由多个内存“体”组成，每个内存体能够独立访问。','1',''),
	(108,4,'非阻塞发送语句可以用阻塞接收语句来接收。','1',''),
	(109,4,'在写回 Cache 中，数据不是立即更新到主存中，而是将发生数据更新的高速缓存行标记为脏。','1',''),
	(110,4,'当一个 for 循环存在循环依赖时不能被并行化。','1',''),
	(111,0,'{\"len\": 4, \"1\": \"single\", \"title\": \"指定代码只能由线程组中的一个线程执行的 OpenMP 编译制导命令是\", \"3\": \"atomic\", \"0\": \"master\", \"2\": \"critical\"}','B',''),
	(112,0,'{\"len\": 4, \"1\": \"Store-conditional 指令和普通的 Store 指令没有差别，只是多核处理器上的特别叫法。\", \"title\": \"下面关于 Load-link 和 Store-conditional 指令的说法，正确的是\", \"3\": \"Load-link 指令有可能失败。\", \"0\": \"Load-link 和普通的 Load 指令没有差别，只是多核处理器上的特别叫法。\", \"2\": \"Load-link 和 Store-conditional 指令可以用于实现同步原语。\"}','C',''),
	(113,0,'{\"len\": 4, \"1\": \"速率\", \"title\": \"链路的（ ）是指它传输数据的速度。\", \"3\": \"延迟带宽积\", \"0\": \"带宽\", \"2\": \"延迟\"}','A',''),
	(114,0,'{\"len\": 4, \"1\": \"barrier\", \"title\": \"在并行域当中，在一段代码临界区之前只有一个线程进入，是使用什么关键字\", \"3\": \"master\", \"0\": \"critical\", \"2\": \"atomic\"}','A',''),
	(115,0,'{\"len\": 4, \"1\": \"M/(0.85+0.015M)\", \"title\": \"假设有一个计算问题，其中串行计算量占 15%。为实现并行计算，需要增加 1.5%的计算量，这部分计算量是不能并行执行的，并且与所使用处理器/执行内核的数量无关。此外，每个处理器执行内核在执行并行计算任务的过程中，还需要执行为所承担的并行任务执行一定的额外操作。这些额外操作的计算量是所承担并行任务量 的 0.1%。请问，在一个有 M 颗处理器/执行内核的计算平台上，并行程序可取得的最大加速比是多少？\", \"3\": \"M/(0.85085+0.015M)\", \"0\": \"M/0.85\", \"2\": \"M/(0.85085+0.165M)\"}','C',''),
	(116,0,'{\"title\": \"缓存一致性强迫多个线程看起来好像是共享同一个内存单元，这称为()\", \"len\": 2, \"1\": \"伪共享\", \"0\": \"共享\"}','B',''),
	(117,0,'{\"len\": 4, \"1\": \"堆\", \"title\": \"在 OpenMP 中，用 threadprivate 作用域标记的变量会存储在内存中的什么位置：\", \"3\": \"DATA 段\", \"0\": \"栈\", \"2\": \"线程局部存储\"}','C',''),
	(118,0,'{\"title\": \"Intel(R)线程档案器为 OpenMP  提供了哪些功能？( ) A  并行代码和顺序代码的时间花费\", \"len\": 3, \"1\": \"并行过载和顺序过载\", \"0\": \"线程任务量不均衡\", \"2\": \"以上都是\"}','C',''),
	(119,0,'{\"title\": \"MPI 的名字( )  前缀 MPI_\", \"len\": 3, \"1\": \"都有\", \"0\": \"都没有\", \"2\": \"可有可无\"}','B',''),
	(120,0,'{\"title\": \"在 MPI 里涉及通信子中所有进程的通信函数是函数 ( )\", \"len\": 3, \"1\": \"集合通信\", \"0\": \"点对点通信\", \"2\": \"广播\"}','B',''),
	(121,0,'{\"len\": 4, \"1\": \"任务串行\", \"title\": \"编写并行程序将待解决问题所需要处理的数据分配给各个核的方法是（）\", \"3\": \"数据串行\", \"0\": \"任务并行\", \"2\": \"数据并行\"}','C',''),
	(122,0,'{\"len\": 4, \"1\": \"16\", \"title\": \"AMD 的 Radeon7970 图形卡包括（ ）个向量处理器(计算单元)?\", \"3\": \"64\", \"0\": \"4\", \"2\": \"32\"}','C',''),
	(123,0,'{\"len\": 4, \"1\": \"静态功率\", \"title\": \"CMOS 的动态功耗等于\", \"3\": \"动态功率与静态功率之和\", \"0\": \"动态功率\", \"2\": \"动态功率和静态功率中较小的功率\"}','D',''),
	(124,0,'{\"title\": \"串行时间与并行时间的比值叫做\", \"len\": 2, \"1\": \"加速比\", \"0\": \"效率\"}','B',''),
	(125,0,'{\"len\": 4, \"1\": \"142\", \"title\": \"要配置双精度浮点峰值性能是 20TFlops 的 HPC 集群，目前采用双路 2.93GHz  Intel  westmere 六核处理器 X5670来构建，我们知道该处理器的每个核都有两套浮点向量计算单元，问该集群共需要多少个计算节点？\", \"3\": \"36；\", \"0\": \"284\", \"2\": \"71\"}','B',''),
	(126,0,'{\"len\": 4, \"1\": \"KNC\", \"title\": \"What\'s the code name of 2nd generation Xeon Phi product?\", \"3\": \"KNH\", \"0\": \"KNF\", \"2\": \"KNL\"}','C',''),
	(127,0,'{\"len\": 4, \"1\": \"48\", \"title\": \"How many cores on the Intel Xeon Phi product at least?\", \"3\": \"72\", \"0\": \"61\", \"2\": \"57\"}','C',''),
	(128,0,'{\"len\": 4, \"1\": \"2\", \"title\": \"How many VPU will be available on the 2nd generation Xeon Phi product?\", \"3\": \"4\", \"0\": \"1\", \"2\": \"3\"}','B',''),
	(129,0,'{\"title\": \"Which one is not the frequently used skills to tune MPI application?\", \"len\": 3, \"1\": \"Remove MPI barrier\", \"0\": \"Relace static task partition with dynamic task partition\", \"2\": \"atomic computation\"}','C',''),
	(130,0,'{\"len\": 4, \"1\": \"Replace 2D structure with 1D\", \"title\": \"Which skill is not used for data restructure?\", \"3\": \"Loop fusion and Loop Split\", \"0\": \"Replace arrays with temporary variable\", \"2\": \"AoS-＞SoA\"}','D',''),
	(131,1,'{\"title\": \"下面是 MPI 可以绑定的语言的是( )\", \"len\": 3, \"1\": \"C++语言\", \"0\": \"C 语言\", \"2\": \"Fortran  语言\"}','A;B;C',''),
	(132,1,'{\"title\": \"MPI 的消息传递过程分为 ( )\", \"len\": 3, \"1\": \"消息装配\", \"0\": \"消息拆卸\", \"2\": \"消息传递\"}','A;B;C',''),
	(133,1,'{\"len\": 4, \"1\": \"合并\", \"title\": \"如果进程是执行的“主线程”，其他线程由主线程启动和停止，那么我们可以设想进程和它的子线程如下进行， 当一个线程开始时，它从进程中（ ）出来；当一个线程结束，它（ ）到进程中。\", \"3\": \"消亡\", \"0\": \"派生\", \"2\": \"分离\"}','A;B',''),
	(134,1,'{\"len\": 6, \"1\": \"执行终止\", \"title\": \"作为多遍优化算法 PGO 的三步过程由以下哪三步构成？( )\", \"5\": \"代码执行与评估\", \"3\": \"执行被插入信息采集代码的程序(Instrumented execution)\", \"4\": \"插入信息采集代码后编译(Instrumented compilation)\", \"0\": \"代码编译\", \"2\": \"反馈编译（feedback compilation）\"}','C;D',''),
	(135,1,'{\"len\": 4, \"1\": \"使用原子操作来替代锁。\", \"title\": \"对于如何解决串行化方面的难题，以下表述正确的是：()\", \"3\": \"设计并行指令\", \"0\": \"少用锁，甚至采用无锁编程。\", \"2\": \"从设计和算法层面来缩小串行化所占的比例。\"}','A;B;C',''),
	(136,1,'{\"len\": 4, \"1\": \"在 MPI 并行程序中，同一个串行函数，可以同时被多个进程分别执行\", \"title\": \"关于函数调用，下列哪些说法是正确的？\", \"3\": \"在 pthread 并行程序中，不允许 worker 线程执行线程创建操作\", \"0\": \"在 pthread 并行程序中，不允许 worker 线程执行函数调用\", \"2\": \"在 MPI 并行程序中，如果一个某个函数的数据运算划分到多个处理器上并行执行，则在参与计算的处理器 上都要执行该函数的调用\"}','B;C;D',''),
	(137,1,'{\"title\": \"The common used vectorization methods include__\", \"len\": 2, \"1\": \"Intrinsics\", \"0\": \"Auto-Vectorized using \\\"pragma\\\" *B Intel? Cilk? Plus Array Notations *C Elemental Functions\"}','A;B',''),
	(138,1,'{\"title\": \"To achieve the good load balance, which items may be needs to considered?\", \"len\": 3, \"1\": \"Communication and I/O\", \"0\": \"Computation Granularity *B Load Balance\", \"2\": \"Synchronization Overhead\"}','A;B;C',''),
	(139,1,'{\"len\": 4, \"1\": \"pragma simd\", \"title\": \"Frenquently used pragma for vectorization includes\", \"3\": \"pragma loop count(n)\", \"0\": \"pragma ivdep\", \"2\": \"pragma vector align\"}','A;B;C;D',''),
	(140,0,'{\"len\": 4, \"1\": \"堆\", \"title\": \"在 OpenMP 中，用 threadprivate 作用域标记的变量会存储在内存中的什么位置：\", \"3\": \"DATA 段\", \"0\": \"栈\", \"2\": \"线程局部存储\"}','C',''),
	(141,0,'{\"len\": 4, \"1\": \"网格\", \"title\": \"（）提供一种基础架构，使地理上分布的计算机大型网络转换成一个分布式内存系统，通常这样的系统是异构 的。\", \"3\": \"共享内存系统\", \"0\": \"集群\", \"2\": \"分布式内存系统\"}','B',''),
	(142,0,'{\"title\": \"在 MPI 里涉及通信子中所有进程的通信函数是函数 ( )\", \"len\": 3, \"1\": \"集合通信\", \"0\": \"点对点通信\", \"2\": \"广播\"}','B',''),
	(143,0,'{\"len\": 4, \"1\": \"在引入线程的操作系统中，则把线程作为 CPU  调度和分派的基本单位\", \"title\": \"以下表述不正确的是：( )\", \"3\": \"由一个进程中的线程切换到另一进程中的线程时，也不会引起进程切换\", \"0\": \"在传统的操作系统中，CPU  调度和分派的基本单位是进程\", \"2\": \"同一进程中线程的切换不会引起进程切换，从而避免了昂贵的系统调用\"}','D',''),
	(144,0,'{\"title\": \"一个条件变量总是与一个 ( )相关联\", \"len\": 2, \"1\": \"互斥量\", \"0\": \"信号量\"}','B',''),
	(145,0,'{\"len\": 4, \"1\": \"任务,线程\", \"title\": \"OpenCL 提供了基于()和基于()的两种并行计算方式.\", \"3\": \"进程,数据\", \"0\": \"任务,数据\", \"2\": \"数据,线程\"}','A',''),
	(146,0,'{\"title\": \"当 CPU 向 Cache 中写数据时，Cache 中的值就会不同或者不一致，有两种方法：写直达和（ ）来解决这个不一 致性问题。\", \"len\": 3, \"1\": \"重复写\", \"0\": \"写回法\", \"2\": \"备份\"}','A',''),
	(147,0,'{\"len\": 4, \"1\": \"并行程序的运行时间越短，加速比越高\", \"title\": \"关于加速比，正确的说法是：\", \"3\": \"根据 Amdahl 定理，并行程序的加速比小于参与计算的处理器执行核数量\", \"0\": \"在 MIM*D 并行计算机上，并行程序的加速比不能随处理器执行核的数量按比例增长\", \"2\": \"确定了运行计算平台、及所使用的处理器数量，就可以确定并行程序的加速比\"}','A',''),
	(148,0,'{\"len\": 4, \"1\": \"负载平衡\", \"title\": \"在（）中，一个进程必须调用一个发送函数，并且发送函数必须与另一个进程调用的接受函数相匹配。\", \"3\": \"异步\", \"0\": \"消息传递\", \"2\": \"同步\"}','A',''),
	(149,0,'{\"len\": 4, \"1\": \"任务串行\", \"title\": \"编写并行程序将待解决问题所需要处理的数据分配给各个核的方法是（）\", \"3\": \"数据串行\", \"0\": \"任务并行\", \"2\": \"数据并行\"}','C',''),
	(150,0,'{\"title\": \"#pragma omp for collapse(2)的作用是什么？\", \"len\": 3, \"1\": \"最里层 for 循环用两个线程处理\", \"0\": \"合并最里面两层循环\", \"2\": \"合并最外两层循环\"}','C',''),
	(151,0,'{\"title\": \"（ ）是指计时器的时间测量单位，是计时器在计时的过程中最短的非零时间跨度。\", \"len\": 3, \"1\": \"电压\", \"0\": \"分辨率\", \"2\": \"电流\"}','A',''),
	(152,0,'{\"title\": \"条件变量是一个数据对象，允许线程在某个特定条件或事件发生前都处于 ( )状态\", \"len\": 2, \"1\": \"挂起\", \"0\": \"死锁\"}','B',''),
	(153,0,'{\"len\": 4, \"1\": \"并行计算机访存模型只有 NUMA、COMA 和 NORMA 这三种类型\", \"title\": \"下面哪个关于并行计算机的访存模型描述是对的？\", \"3\": \"COMA 模型是 Coherent-Only Memory Access 的缩写。\", \"0\": \"NUMA 模型是高速缓存一致的、非均匀存储访问模型的简称。\", \"2\": \"多台 P*C 机通过网线连接形成的机群属于 NORM*A 非远程存储访问模型。\"}','C',''),
	(154,0,'{\"title\": \"在一个集合通信中，如果属于一个进程的数据被发送到通信子中的所有进程，则这样的集合通信叫做 ( ) A  点对点通信\", \"len\": 2, \"1\": \"广播\", \"0\": \"集合通信\"}','B',''),
	(155,0,'{\"title\": \"串行时间与并行时间的比值叫做\", \"len\": 2, \"1\": \"加速比\", \"0\": \"效率\"}','B',''),
	(156,0,'{\"title\": \"不同进程对同一个内容的输出，其顺序是( )\", \"len\": 2, \"1\": \"特定的\", \"0\": \"随机的\"}','A',''),
	(157,0,'{\"len\": 4, \"1\": \"共享存储并行计算模型包括 LogP 模型和 PRAM 模型\", \"title\": \"下面关于并行计算模型，哪个描述是正确的？\", \"3\": \"分布式存储并行计算模型包括 LogP 模型和 BSP 模型；\", \"0\": \"共享存储并行计算模型包括 PRAM 模型和 BSP 模型\", \"2\": \"分布式存储并行计算模型包括 PRAM 模型和 BSP 模型\"}','D',''),
	(158,0,'{\"len\": 4, \"1\": \"CUDA\", \"title\": \"（ ）和 OpenMP 是为共享内存系统的编程而设计的，它们提供访问共享内存的机制。\", \"3\": \"Pthreads\", \"0\": \"MPI\", \"2\": \"MapReduce\"}','D',''),
	(159,0,'{\"len\": 4, \"1\": \"2X\", \"title\": \"How much improvement of Single-Thread Performance on 2nd generation compared to the 1st generation Intel Xeon Phi coprocessor?\", \"3\": \"4X\", \"0\": \"3X\", \"2\": \"1.5X\"}','A',''),
	(160,0,'{\"len\": 4, \"1\": \"512bits\", \"title\": \"How long is vector length on Xeon Phi?\", \"3\": \"64bits\", \"0\": \"128bits\", \"2\": \"256bits\"}','B',''),
	(161,0,'{\"len\": 4, \"1\": \"8GB\", \"title\": \"What \'s the maxmum size of on-package memory (MCDRAM) will be available on 2nd generation Xeon Phi?\", \"3\": \"32GB\", \"0\": \"4GB\", \"2\": \"16GB\"}','C',''),
	(162,0,'{\"len\": 4, \"1\": \"4\", \"title\": \"How many channels of DDR4 will be available on 2nd generation Xeon Phi?\", \"3\": \"10\", \"0\": \"6\", \"2\": \"8\"}','A',''),
	(163,0,'{\"len\": 4, \"1\": \"KNC\", \"title\": \"What\'s the code name of 2nd generation Xeon Phi product?\", \"3\": \"KNH\", \"0\": \"KNF\", \"2\": \"KNL\"}','C',''),
	(164,1,'{\"title\": \"下面是 MPI 可以绑定的语言的是( )\", \"len\": 3, \"1\": \"C++语言\", \"0\": \"C 语言\", \"2\": \"Fortran  语言\"}','A;B;C',''),
	(165,1,'{\"len\": 4, \"1\": \"MKL  使用 OpenMP*  实现多线程\", \"title\": \"下面关于英特 MKL 多线程的特性，哪些是正确的？( )\", \"3\": \"MKL  函数内部实现了多线程，但 MKL 库不是线程安全的\", \"0\": \"MKL  是线程安全的， 可以在多线程中被使用\", \"2\": \"MKL  函数内部实现了多线程\"}','A;B;C',''),
	(166,1,'{\"title\": \"TBB 支持的 C++编译器包括：( )\", \"len\": 3, \"1\": \"GNU\", \"0\": \"Microsoft\", \"2\": \"Intel\"}','A;B;C',''),
	(167,1,'{\"title\": \"以下属于 TBB 中的并行容器的是：( )\", \"len\": 3, \"1\": \"concurrent_queue\", \"0\": \"concurrent_set\", \"2\": \"concurrent_hash_map *D concurrent_vector\"}','B;C',''),
	(168,1,'{\"len\": 5, \"1\": \"执行终止\", \"title\": \"作为多遍优化算法 PGO 的三步过程由以下哪三步构成？( )\", \"3\": \"执行被插入信息采集代码的程序(Instrumented execution) E  插入信息采集代码后编译(Instrumented compilation)\", \"4\": \"代码执行与评估\", \"0\": \"代码编译\", \"2\": \"反馈编译（feedback compilation）\"}','C;D',''),
	(169,1,'{\"len\": 4, \"1\": \"进程 0 先执行 MPI_Recv 接收 M1、然后执行 MPI_Send 发送 M0，进程 1 执行 MPI_Recv 接收 M0、然后先执行 MPI_Send 发送 M1\", \"title\": \"进程 0 要将消息 M0 发送给进程 1，进程 1 要将消息 M1 发送给进程 0。下列哪几种情况下，可能出现“死锁”？\", \"3\": \"进程 0 先执行 MPI_IRecv 接收 M1、然后执行 MPI_Send 发送 M0，进程 1 执行 MPI_Recv 接收 M0、然后先执行 MPI_Send 发送 M1\", \"0\": \"进程 0 先执行 MPI_Send 发送 M0、然后执行 MPI_Recv 接收 M1，进程 1 先执行 MPI_Send 发送 M1、然后执行 MPI_Recv 接收 M0\", \"2\": \"进程 0 先执行 MPI_ISend 发送 M0、然后执行 MPI_Recv 接收 M1，进程 1 先执行 MPI_Send 发送 M1、然后执行 MPI_Recv 接收 M0\"}','A;B;C',''),
	(170,1,'{\"title\": \"MPI 的消息传递过程分为 ( )\", \"len\": 3, \"1\": \"消息装配\", \"0\": \"消息拆卸\", \"2\": \"消息传递\"}','A;B;C',''),
	(171,1,'{\"len\": 4, \"1\": \"处理器的乱序执行\", \"title\": \"以下哪些选项有可能使得程序不会按照程序本身的顺序执行的\", \"3\": \"使用单核 CPU\", \"0\": \"编译器的编译优化\", \"2\": \"使用原子操作\"}','A;B',''),
	(172,1,'{\"len\": 4, \"1\": \"pragma prefetch\", \"title\": \"In order to improve memory bandwidth, comman used skills inlclude:\", \"3\": \"AoS-＞SoA\", \"0\": \"Use nontemporal pragma\", \"2\": \"the option of \\\"-qopt-streaming-stores=always\\\"\"}','A;C',''),
	(173,1,'{\"title\": \"Data alignment about dynamic memory can be achieved by __.\", \"len\": 3, \"1\": \"mm_aligned_malloc(size, alignment_bytes)/);    mm_aligned_free()\", \"0\": \"__attribute    ((aligned(n)))\", \"2\": \"scalable_aligned_malloc()/scalable_aligned_free()\"}','B;C',''),
	(174,0,'{\"len\": 4, \"1\": \"70%\", \"title\": \"某并行任务中，通信部分占总时间 50%，计算占%40，而并行带来的额外开销占%10。经过优化，使得 通信与计算得到部分重叠，有 40%的通信时间被计算重叠。此时，总时间为原本的\", \"3\": \"90%\", \"0\": \"60%\", \"2\": \"80%\"}','C',''),
	(175,0,'{\"title\": \"（ ）为程序员提供了一种机制，将程序划分为多个大致独立的任务，当某个任务阻塞时能执行其他任 务。\", \"len\": 3, \"1\": \"线程\", \"0\": \"进程\", \"2\": \"接口\"}','B',''),
	(176,0,'{\"len\": 4, \"1\": \"1\", \"title\": \"在 Concurrent read concurrent write (CRCW) PRAM 模型中，两个处理器同时对初值为 0 的内存空间进行 加一操作（*p = *p + 1）。当其中一个处理器完成其操作时，该内存空间不可能的值是：\", \"3\": \"以上都有可能\", \"0\": \"0\", \"2\": \"2\"}','A',''),
	(177,0,'{\"len\": 4, \"1\": \"Store-conditional 指令和普通的 Store 指令没有差别，只是多核处理器上的特别叫法。\", \"title\": \"下面关于 Load-link 和 Store-conditional 指令的说法，正确的是\", \"3\": \"Load-link 指令有可能失败。\", \"0\": \"Load-link 和普通的 Load 指令没有差别，只是多核处理器上的特别叫法。\", \"2\": \"Load-link 和 Store-conditional 指令可以用于实现同步原语。\"}','C',''),
	(178,0,'{\"len\": 4, \"1\": \"并行计算机访存模型只有 NUMA、COMA 和 NORMA 这三种类型\", \"title\": \"下面哪个关于并行计算机的访存模型描述是对的？\", \"3\": \"COMA 模型是 Coherent-Only Memory Access 的缩写。\", \"0\": \"NUMA 模型是高速缓存一致的、非均匀存储访问模型的简称。\", \"2\": \"多台 PC 机通过网线连接形成的机群属于 NORMA 非远程存储访问模型。\"}','C',''),
	(179,0,'{\"len\": 4, \"1\": \"速率\", \"title\": \"链路的（ ）是指它传输数据的速度。\", \"3\": \"延迟带宽积\", \"0\": \"带宽\", \"2\": \"延迟\"}','A',''),
	(180,0,'{\"len\": 4, \"1\": \"barrier\", \"title\": \"在并行域当中，指定一个数据操作原子性操作完成，是使用什么关键字\", \"3\": \"master\", \"0\": \"atomic\", \"2\": \"single\"}','A',''),
	(181,0,'{\"len\": 4, \"1\": \"测试阶段\", \"title\": \"我们应该在产品生命周期中的哪个阶段考虑产品的性能？( )?\", \"3\": \"以上全部?\", \"0\": \"设计阶段\", \"2\": \"需求收集阶段\"}','C',''),
	(182,0,'{\"len\": 4, \"1\": \"1\", \"title\": \"在 Exclusive read exclusive write (EREW) PRAM 模型中，三个处理器同时对初值为 0 的内存空间进行加一 操作（*p = *p + 1）。当所有处理器完成其操作时，该内存空间不可能的值是：\", \"3\": \"以上均不可能\", \"0\": \"0\", \"2\": \"2\"}','D',''),
	(183,0,'{\"len\": 4, \"1\": \"线程\", \"title\": \"有两种主要方法来实现指令级并行：流水线和（ ）。\", \"3\": \"多发射\", \"0\": \"进程\", \"2\": \"接口\"}','D',''),
	(184,0,'{\"len\": 4, \"1\": \"2\", \"title\": \"Intel Xeon Phi 处理器中，每个核有几个硬件线程。\", \"3\": \"8\", \"0\": \"1\", \"2\": \"4\"}','C',''),
	(185,0,'{\"len\": 4, \"1\": \"single\", \"title\": \"在并行域当中，使代码线程同步，是使用什么关键字\", \"3\": \"master\", \"0\": \"barrier\", \"2\": \"atomic\"}','A',''),
	(186,0,'{\"len\": 4, \"1\": \"运行\", \"title\": \"在（ ）时，一个线程进入一个循环，这个循环的目的只是测试一个条件。\", \"3\": \"休眠\", \"0\": \"忙等待\", \"2\": \"就绪\"}','A',''),
	(187,0,'{\"len\": 4, \"1\": \"512bits\", \"title\": \"How long is vector length on Xeon Phi?\", \"3\": \"64bits\", \"0\": \"128bits\", \"2\": \"256bits\"}','B',''),
	(188,0,'{\"len\": 4, \"1\": \"2\", \"title\": \"How many VPU will be available on the 2nd generation Xeon Phi product?\", \"3\": \"4\", \"0\": \"1\", \"2\": \"3\"}','B',''),
	(189,0,'{\"len\": 4, \"1\": \"2X\", \"title\": \"How much improvement of Single-Thread Performance on 2nd generation compared to the 1st generation Intel Xeon Phi coprocessor?\", \"3\": \"4X\", \"0\": \"3X\", \"2\": \"1.5X\"}','A',''),
	(190,0,'{\"title\": \"How many cores on the Intel Xeon Phi product at least?\", \"len\": 3, \"1\": \"48\", \"0\": \"61\", \"2\": \"57\"}','C',''),
	(191,0,'{\"len\": 4, \"1\": \"Cache blocking\", \"title\": \"Which one is the freqently used skill to improve data locality?\", \"3\": \"data restructure\", \"0\": \"Data alignment\", \"2\": \"Prefetch\"}','B',''),
	(192,0,'{\"len\": 4, \"1\": \"O2\", \"title\": \"What\'s the default vectorization option for Intel Compiler?\", \"3\": \"O0\", \"0\": \"O1\", \"2\": \"O3\"}','B',''),
	(193,0,'{\"len\": 4, \"1\": \"8GB\", \"title\": \"What \'s the maxmum size of on-package memory (MCDRAM) will be available on 2nd generation Xeon Phi?\", \"3\": \"32GB\", \"0\": \"4GB\", \"2\": \"16GB\"}','C',''),
	(194,1,'{\"len\": 4, \"1\": \"使用原子操作来替代锁。\", \"title\": \"对于如何解决串行化方面的难题，以下表述正确的是：()\", \"3\": \"设计并行指令\", \"0\": \"少用锁，甚至采用无锁编程。\", \"2\": \"从设计和算法层面来缩小串行化所占的比例。\"}','A;B;C',''),
	(195,1,'{\"len\": 4, \"1\": \"在引入线程的操作系统中，一个进程中的多个线程之间不可以并发执行\", \"title\": \"以下表述正确的是：( )\", \"3\": \"线程是拥有系统资源的一个独立单位，它可以拥有自己的资源\", \"0\": \"在引入线程的操作系统中，进程之间可以并发执行\", \"2\": \"进程是拥有系统资源的一个独立单位，它可以拥有自己的资源\"}','A;C',''),
	(196,1,'{\"title\": \"Intel  调优助手能够给我们自动推荐代码改进办法，主要有以下哪些方面？ ( ) A  算法自动改进\", \"len\": 3, \"1\": \"取样向导增强\", \"0\": \"处理器瓶颈以及改进\", \"2\": \"超线程\"}','A;B;C',''),
	(197,1,'{\"title\": \"避免对临界区竞争访问的基本方法有 ()\", \"len\": 3, \"1\": \"互斥量\", \"0\": \"忙等待\", \"2\": \"信号量\"}','A;B;C',''),
	(198,1,'{\"title\": \"请说出目前 MPI 的主要免费实现的种类 ()\", \"len\": 3, \"1\": \"LAM\", \"0\": \"MPICH\", \"2\": \"CHIMP\"}','A;B;C',''),
	(199,1,'{\"title\": \"TBB 支持的 C++编译器包括：( )\", \"len\": 3, \"1\": \"GNU\", \"0\": \"Microsoft\", \"2\": \"Intel\"}','A;B;C',''),
	(200,1,'{\"len\": 4, \"1\": \"Offload\", \"title\": \"The features supported on the 1st generation Xeon Phi include__\", \"3\": \"Symmetric\", \"0\": \"Native\", \"2\": \"Self-boot\"}','A;B;D',''),
	(201,1,'{\"len\": 4, \"1\": \"pragma prefetch\", \"title\": \"In order to improve memory bandwidth, comman used skills inlclude:\", \"3\": \"AoS-＞SoA\", \"0\": \"Use nontemporal pragma\", \"2\": \"the option of \\\"-qopt-streaming-stores=always\\\"\"}','A;C',''),
	(202,0,'{\"title\": \"以下哪个事例是 Vtune 性能分析器的基于事件的采样？ ( )\", \"len\": 3, \"1\": \"Every n processor ticks\", \"0\": \"Branch misprediction\", \"2\": \"Bugs encountered\"}','A',''),
	(203,0,'{\"len\": 4, \"1\": \"1MB\", \"title\": \"Mmap()函数可以申请大页表空间，请问它申请的空间，每个页表的大小是多少?\", \"3\": \"4MB\", \"0\": \"512KB\", \"2\": \"2MB\"}','C',''),
	(204,0,'{\"len\": 4, \"1\": \"data section\", \"title\": \"同一进程下的线程可以共享以下\", \"3\": \"thread ID\", \"0\": \"stack\", \"2\": \"register set\"}','B',''),
	(205,0,'{\"title\": \"在 MPI 中 ( )  指的是一组可以互相发送消息的进程集合\", \"len\": 2, \"1\": \"标签\", \"0\": \"通信子\"}','A',''),
	(206,0,'{\"title\": \"如果程序可以在不增加问题规模的前提下维持恒定效率，那么程序拥有( )  扩展性\", \"len\": 2, \"1\": \"强\", \"0\": \"弱\"}','B',''),
	(207,0,'{\"title\": \"在任何一个 MIMD 系统中，如果处理器异步执行，那么很可能会引发（ ）。\", \"len\": 3, \"1\": \"弱确定性\", \"0\": \"强确定性\", \"2\": \"非确定性\"}','C',''),
	(208,0,'{\"title\": \"如果一个进程试图接收消息，但没有相匹配的消息，那么该进程将会被永远阻塞在那里,这种情况叫做( )\", \"len\": 3, \"1\": \"进程阻\", \"0\": \"进程悬挂\", \"2\": \"进程死锁\"}','A',''),
	(209,0,'{\"title\": \"在 Pthreads 中实现路障的更好方法是采用 ( )\", \"len\": 2, \"1\": \"互斥量\", \"0\": \"条件变量\"}','A',''),
	(210,0,'{\"len\": 4, \"1\": \"一个条件信号可以唤醒多个线程\", \"title\": \"关于 pthread 线程并行模型，正确的说法是：\", \"3\": \"采用互斥锁机制，可以解决线程之间的“读-写”冲突\", \"0\": \"各个线程共享同一个存储空间\", \"2\": \"允许两个线程同时处于相同的临界区\"}','B',''),
	(211,0,'{\"len\": 4, \"1\": \"在创建或撤消进程时，系统都要为之分配或回收资源\", \"title\": \"以下表述不正确的是：( )\", \"3\": \"线程切换只需保存和设置少量寄存器的内容，并不涉及存储器管理方面的操作\", \"0\": \"人们习惯上称线程为轻量级进程（lightweight process, LWP），线程是 CPU  调度和分派的基本单元\", \"2\": \"进程切换的开销也远小于线程切换的开销\"}','C',''),
	(212,0,'{\"len\": 4, \"1\": \"采用超标量技术\", \"title\": \"提高微处理器内部执行的并行性有哪些措施。( )\", \"3\": \"以上都不是\", \"0\": \"采用超级流水线技术\", \"2\": \"以上都是\"}','C',''),
	(213,0,'{\"len\": 4, \"1\": \"重复写\", \"title\": \"在（ ）Cache 中，当 CPU 向 Cache 写数据时，高速缓存行会立即写入主存中。\", \"3\": \"写直达\", \"0\": \"写回法\", \"2\": \"备份\"}','D',''),
	(214,0,'{\"title\": \"通常（ ）用对并行硬件进行分类，通过系统可以处理的指令流数目和数据流数目来区别各个分类。\", \"len\": 3, \"1\": \"PCAM 方法\", \"0\": \"Flynn 分类法\", \"2\": \"KMP 算法\"}','A',''),
	(215,0,'{\"len\": 4, \"1\": \"测试阶段\", \"title\": \"我们应该在产品生命周期中的哪个阶段考虑产品的性能？( )?\", \"3\": \"以上全部?\", \"0\": \"设计阶段\", \"2\": \"需求收集阶段\"}','C',''),
	(216,0,'{\"title\": \"当用户运行一个程序时，操作系统创建一个（ ）。\", \"len\": 3, \"1\": \"线程\", \"0\": \"进程\", \"2\": \"接口\"}','A',''),
	(217,0,'{\"len\": 4, \"1\": \"线程是 CPU 调度和分派的基本单位\", \"title\": \"关于进程和线程的描述中不正确的是\", \"3\": \"线程必须依存在进程中，由进程提供多个线程执行的控制\", \"0\": \"进程和线程都可以独立执行\", \"2\": \"进程是系统进行资源分配和调度的一个独立单位\"}','A',''),
	(218,0,'{\"len\": 4, \"1\": \"MPI_Allreduce\", \"title\": \"在 MPI 集合通信中，下列哪一个函数可以完成多个进程间的前缀和（prefix sum）计算：\", \"3\": \"MPI_Scan\", \"0\": \"MPI_Reduce\", \"2\": \"MPI_Reduce_scatter\"}','D',''),
	(219,0,'{\"title\": \"MPI 要求消息是 ( )\", \"len\": 2, \"1\": \"可超越的\", \"0\": \"不可超越的\"}','A',''),
	(220,0,'{\"len\": 4, \"1\": \"请求与保持条件：一个进程因请求资源而阻塞时，对已获得的资源保持不放\", \"title\": \"产生死锁的必要条件不包括\", \"3\": \"循环等待条件:若干进程之间形成一种头尾相接的循环等待资源关系\", \"0\": \"互斥条件：一个资源每次只能被一个进程使用\", \"2\": \"资源分配不当:资源分配的顺序不合理\"}','C',''),
	(221,0,'{\"title\": \"标签不匹配和目标进程的进程号与源进程的进程号不相同都会导致 （）\", \"len\": 3, \"1\": \"进程阻碍\", \"0\": \"进程悬挂\", \"2\": \"进程死锁\"}','A',''),
	(222,0,'{\"len\": 4, \"1\": \"IMCI\", \"title\": \"What\'s the instruction set on 2nd generation xeon phi?\", \"3\": \"AVX-512\", \"0\": \"SSE\", \"2\": \"AVX2\"}','D',''),
	(223,0,'{\"len\": 4, \"1\": \"pragma prefetch\", \"title\": \"Which skill is not used for prefetch?\", \"3\": \"Cache blocking\", \"0\": \"Add compiler option\", \"2\": \"prefetch intrinsic\"}','D',''),
	(224,1,'{\"title\": \"请说出目前 MPI 的主要免费实现的种类 ()\", \"len\": 3, \"1\": \"LAM\", \"0\": \"MPICH\", \"2\": \"CHIMP\"}','A;B;C',''),
	(225,1,'{\"len\": 4, \"1\": \"避免冗余的函数调用\", \"title\": \"独立于体系结构性能优化方法主要有：( )\", \"3\": \"利 用局部变量保存中间计算结果\", \"0\": \"编写适用于特定 CPU  的优化代码\", \"2\": \"避免不必要的边界检查\"}','B;C;D',''),
	(226,1,'{\"len\": 4, \"1\": \"合并\", \"title\": \"如果进程是执行的“主线程”，其他线程由主线程启动和停止，那么我们可以设想进程和它的子线程如 下进行，当一个线程开始时，它从进程中（ ）出来；当一个线程结束，它（ ）到进程中。\", \"3\": \"消亡\", \"0\": \"派生\", \"2\": \"分离\"}','A;B',''),
	(227,1,'{\"len\": 4, \"1\": \"扩展指令集\", \"title\": \"对于现代微处理器体系结构而言，对性能优化影响比较大的主要是：( )\", \"3\": \"指令流水线的深度\", \"0\": \"超标量\", \"2\": \"乱序执行\"}','A;C;D',''),
	(228,1,'{\"len\": 4, \"1\": \"IPP 性能库\", \"title\": \"英特尔 Parallel Composer 主要包含：( )\", \"3\": \"TBB 多线程开发库\", \"0\": \"Intel C/C++编译器\", \"2\": \"MKL 函数库\"}','A;B;D',''),
	(229,1,'{\"len\": 4, \"1\": \"随机取样\", \"title\": \"VTune  性能分析器中的取样功能有哪几种方式？()\", \"3\": \"线性取样\", \"0\": \"基于时间取样\", \"2\": \"基于事件取样\"}','A;C',''),
	(230,1,'{\"len\": 4, \"1\": \"进程 0 先执行 MPI_Recv 接收 M1、然后执行 MPI_Send 发送 M0，进程 1 执行 MPI_Recv 接收 M0、然后先执行 MPI_Send 发送 M1\", \"title\": \"进程 0 要将消息 M0 发送给进程 1，进程 1 要将消息 M1 发送给进程 0。下列哪几种情况下，可能出现 “死锁”？\", \"3\": \"进程 0 先执行 MPI_IRecv 接收 M1、然后执行 MPI_Send 发送 M0，进程 1 执行 MPI_Recv 接收 M0、然后先执行 MPI_Send 发送 M1\", \"0\": \"进程 0 先执行 MPI_Send 发送 M0、然后执行 MPI_Recv 接收 M1，进程 1 先执行 MPI_Send 发送 M1、然后执行 MPI_Recv 接收 M0\", \"2\": \"进程 0 先执行 MPI_ISend 发送 M0、然后执行 MPI_Recv 接收 M1，进程 1 先执行 MPI_Send 发送 M1、然后执行 MPI_Recv 接收 M0\"}','A;B;C',''),
	(231,0,'{\"title\": \"Data alignment about dynamic memory can be achieved by_    .\", \"len\": 2, \"1\": \"mm_aligned_malloc(size, alignment_bytes)/);    mm_aligned_free() *C scalable_aligned_malloc()/scalable_aligned_free()\", \"0\": \"__attribute    ((aligned(n)))\"}','B',''),
	(232,1,'{\"title\": \"Which are the frenquently used multi-thread parallelization methods? A MPI\", \"len\": 3, \"1\": \"Intel Cilk Plus,\", \"0\": \"OpenMP\", \"2\": \"Intel Threading Building Blocks\"}','A;B;C',''),
	(233,0,'{\"title\": \"使用 Intel 编译器时，开关-O2 对代码进行和开关-O1 或/O1 相类似的优化，但是会以什么为“代价”？( )\", \"2\": \"性能优势将只能发挥在某些特定硬件平台上\", \"len\": 3, \"0\": \"没有区别所以没有代价\", \"1\": \"和-O1(/O1)相比可能会大幅增加代码大小\"}','C',''),
	(234,0,'{\"len\": 4, \"1\": \"测试阶段\", \"title\": \"我们应该在产品生命周期中的哪个阶段考虑产品的性能？( )\", \"3\": \"以上全部?\", \"0\": \"设计阶段\", \"2\": \"需求收集阶段\"}','C',''),
	(235,0,'{\"len\": 4, \"1\": \"寄存器集合\", \"title\": \"一个标准的线程不一定需要哪一项资源？\", \"3\": \"堆\", \"0\": \"程序计数器\", \"2\": \"堆栈\"}','D',''),
	(236,0,'{\"len\": 4, \"1\": \"critical\", \"title\": \"在并行域当中，保证各个 openmp 线程数据影像的一致性，是使用什么关键字\", \"3\": \"master\", \"0\": \"flush\", \"2\": \"atomic\"}','A',''),
	(237,0,'{\"len\": 4, \"1\": \"速率\", \"title\": \"两个常用来衡量互连网络性能的指标：（ ）和带宽。\", \"3\": \"抖动\", \"0\": \"稳定\", \"2\": \"延迟\"}','C',''),
	(238,0,'{\"len\": 4, \"1\": \"使用线程池可以避免为每个线程创建新进程的开销\", \"title\": \"以下表述错误的是：()\", \"3\": \"对于有优先级的线程，也可以使用线程池\", \"0\": \"OpenMP  可以根据目标系统尽量使用最优数量的线程个数。\", \"2\": \"线程池通常具有最大线程数限制，如果所有线程都繁忙，而额外的任务将放入队列中，直到有线程可用时 才能够得到处理\"}','D',''),
	(239,0,'{\"len\": 4, \"1\": \"多指令多数据\", \"title\": \"（ ）系统支持同时多个指令流在多个数据流上操作。\", \"3\": \"共享内存\", \"0\": \"单指令多数据\", \"2\": \"分布式内存\"}','B',''),
	(240,0,'{\"title\": \"在任何一个 MIMD 系统中，如果处理器异步执行，那么很可能会引发（ ）。\", \"len\": 3, \"1\": \"弱确定性\", \"0\": \"强确定性\", \"2\": \"非确定性\"}','C',''),
	(241,0,'{\"len\": 4, \"1\": \"线程级\", \"title\": \"（ ）并行是尝试通过同时执行不同线程来提供并行性。\", \"3\": \"任务级\", \"0\": \"进程级\", \"2\": \"程序级\"}','B',''),
	(242,0,'{\"len\": 4, \"1\": \"可以，不会\", \"title\": \"具有不同局部性的存储单元，__放置在同一 cache 行中，这样__引发伪共享问题。( )\", \"3\": \"不可以，不会\", \"0\": \"可以，会\", \"2\": \"不可以，会\"}','C',''),
	(243,0,'{\"len\": 4, \"1\": \"MKL_lapack.lib\", \"title\": \"在 Windows*中静态链接 MKL  的 DFT 函数，应该选择下面哪一个 MKL 库\", \"3\": \"MKL_c_dll.lib\", \"0\": \"MKL_solver.lib\", \"2\": \"MKL_c.lib\"}','B',''),
	(244,0,'{\"len\": 4, \"1\": \"寄存器\", \"title\": \"控制单元有一个特殊的存储器，用来存放下一条指令的地址，叫做（ ）\", \"3\": \"程序计数器\", \"0\": \"主存\", \"2\": \"互联结构\"}','D',''),
	(245,0,'{\"len\": 4, \"1\": \"16\", \"title\": \"AMD 的 Radeon7970 图形卡包括（ ）个向量处理器(计算单元)?\", \"3\": \"64\", \"0\": \"4\", \"2\": \"32\"}','C',''),
	(246,0,'{\"len\": 4, \"1\": \"负载平衡\", \"title\": \"在（）中，一个进程必须调用一个发送函数，并且发送函数必须与另一个进程调用的接受函数相匹配。\", \"3\": \"异步\", \"0\": \"消息传递\", \"2\": \"同步\"}','A',''),
	(247,0,'{\"len\": 4, \"1\": \"Data restructure\", \"title\": \"Which optimization methods is not used in the case of \\\"small matrix multiplication\\\"?\", \"3\": \"Cache Blocking\", \"0\": \"Loop Interchange\", \"2\": \"vectorization\"}','D',''),
	(248,0,'{\"title\": \"Which optimization may not apply for below code?\", \"len\": 3, \"1\": \"Parallelization and Use \\\"pragma omp atomic\\\" to make sure the right result\", \"0\": \"Vectorize the loop\", \"2\": \"Pre-caculate rand() and store into an array\"}','A',''),
	(249,0,'{\"len\": 4, \"1\": \"Improve cache hit rate\", \"title\": \"What is the key reason for performance improvement after replacing Glibc rand() with Intel Math Kernel Library random generator in the case of \\\"Deep Learning\\\"?\", \"3\": \"Parallelization\", \"0\": \"Reduce IO latentcy\", \"2\": \"Vectorization\"}','C',''),
	(250,0,'{\"title\": \"Which one is not the potential issue of the code?\", \"len\": 3, \"1\": \"In the most inner loop, bad vectorization effect,even can\'t be vectorized\", \"0\": \"Can\'t be parallelized in the outer loop\", \"2\": \"non-contiguous memory access\"}','A',''),
	(251,0,'{\"title\": \"Which option is commanly used for detailed vectorization information? D-no-vec\", \"len\": 3, \"1\": \"-fno-alias\", \"0\": \"-ansi-alias\", \"2\": \"-qopt-report\"}','C',''),
	(252,1,'{\"title\": \"MPI 的消息传递过程分为 ( )\", \"len\": 3, \"1\": \"消息装配\", \"0\": \"消息拆卸\", \"2\": \"消息传递\"}','A;B;C',''),
	(253,1,'{\"len\": 4, \"1\": \"concurrent_queue\", \"title\": \"以下属于 TBB 中的并行容器的是：( )\", \"3\": \"concurrent_vector\", \"0\": \"concurrent_set\", \"2\": \"concurrent_hash_map\"}','B;C;D',''),
	(254,1,'{\"title\": \"避免对临界区竞争访问的基本方法有 ()\", \"len\": 3, \"1\": \"互斥量\", \"0\": \"忙等待\", \"2\": \"信号量\"}','A;B;C',''),
	(255,1,'{\"len\": 4, \"1\": \"使用原子操作来替代锁。\", \"title\": \"对于如何解决串行化方面的难题，以下表述正确的是：()\", \"3\": \"设计并行指令\", \"0\": \"少用锁，甚至采用无锁编程。\", \"2\": \"从设计和算法层面来缩小串行化所占的比例。\"}','A;B;C',''),
	(256,1,'{\"title\": \"下面是 MPI 可以绑定的语言的是( )\", \"len\": 3, \"1\": \"C++语言\", \"0\": \"C 语言\", \"2\": \"Fortran  语言\"}','A;B;C',''),
	(257,1,'{\"len\": 4, \"1\": \"Offload\", \"title\": \"The features supported on the 1st generation Xeon Phi include__\", \"3\": \"Symmetric\", \"0\": \"Native\", \"2\": \"Self-boot\"}','A;B;D',''),
	(258,1,'{\"len\": 4, \"1\": \"pragma simd\", \"title\": \"Frenquently used pragma for vectorization includes\", \"3\": \"pragma loop count(n)\", \"0\": \"pragma ivdep\", \"2\": \"pragma vector align\"}','A;B;C;D',''),
	(259,1,'{\"len\": 4, \"1\": \"Intel? Cilk? Plus Array Notations\", \"title\": \"The common used vectorization methods include\", \"3\": \"Intrinsics\", \"0\": \"Auto-Vectorized using \\\"pragma\\\"\", \"2\": \"Elemental Functions\"}','A;B;C;D',''),
	(260,0,'{\"title\": \"如果当问题规模增加，需要通过增大进程数来维持程序效率的，那么程序拥有（）可扩展性\", \"len\": 2, \"1\": \"强\", \"0\": \"弱\"}','A',''),
	(261,0,'{\"title\": \"在并行域当中，指定一段代码由主线程执行，是使用什么关键字\", \"len\": 2, \"1\": \"barrier C atomic D Single\", \"0\": \"master\"}','A',''),
	(262,0,'{\"len\": 4, \"1\": \"请求与保持条件：一个进程因请求资源而阻塞时，对已获得的资源保持不放\", \"title\": \"产生死锁的必要条件不包括\", \"3\": \"循环等待条件:若干进程之间形成一种头尾相接的循环等待资源关系\", \"0\": \"互斥条件：一个资源每次只能被一个进程使用\", \"2\": \"资源分配不当:资源分配的顺序不合理\"}','C',''),
	(263,0,'{\"title\": \"MPI 要求消息是 ( )\", \"len\": 2, \"1\": \"可超越的\", \"0\": \"不可超越的\"}','A',''),
	(264,0,'{\"len\": 4, \"1\": \"每个临界区都有相应的进入区（entry section）和退出区（exit section）\", \"title\": \"以下表述不正确的是：( )\", \"3\": \"临界区的存在就是为了保证当有一个线程在临界区内执行的时候，不能有其他任何进程被允许在临界区执 行\", \"0\": \"当两个或多个进程试图在同一时刻访问共享内存，或读写某些共享数据，就会产生竞争条件\", \"2\": \"可能有两个线程同时进入临界区。\"}','C',''),
	(265,0,'{\"title\": \"在共享内存编程中，运行在一个处理器上的一个程序实例称为( )\", \"len\": 2, \"1\": \"进程\", \"0\": \"线程\"}','A',''),
	(266,0,'{\"title\": \"（ ）为程序员提供了一种机制，将程序划分为多个大致独立的任务，当某个任务阻塞时能执行其他任 务。\", \"len\": 3, \"1\": \"线程\", \"0\": \"进程\", \"2\": \"接口\"}','B',''),
	(267,0,'{\"len\": 4, \"1\": \"CUDA\", \"title\": \"（ ）和 OpenMP 是为共享内存系统的编程而设计的，它们提供访问共享内存的机制。\", \"3\": \"Pthreads\", \"0\": \"MPI\", \"2\": \"MapReduce\"}','D',''),
	(268,0,'{\"len\": 4, \"1\": \"寄存器\", \"title\": \"CPU 中的数据和程序执行时的状态信息存储在特殊的快速存储介质中，即（ ）。\", \"3\": \"程序计数器\", \"0\": \"主存\", \"2\": \"互联结构\"}','B',''),
	(269,0,'{\"len\": 4, \"1\": \"计算强度相当\", \"title\": \"在并行计算中,粗粒度的并行相对细粒度的并行来说\", \"3\": \"时间开销较小\", \"0\": \"计算强度低\", \"2\": \"较难实现负载均衡\"}','C',''),
	(270,0,'{\"len\": 4, \"1\": \"共享存储并行计算模型包括 LogP 模型和 PRAM 模型\", \"title\": \"下面关于并行计算模型，哪个描述是正确的？\", \"3\": \"分布式存储并行计算模型包括 LogP 模型和 BSP 模型；\", \"0\": \"共享存储并行计算模型包括 PRAM 模型和 BSP 模型\", \"2\": \"分布式存储并行计算模型包括 PRAM 模型和 BSP 模型\"}','D',''),
	(271,0,'{\"title\": \"以下哪个事例是 Vtune 性能分析器的基于事件的采样？ ( )\", \"len\": 3, \"1\": \"Every n processor ticks\", \"0\": \"Branch misprediction\", \"2\": \"Bugs encountered\"}','A',''),
	(272,0,'{\"len\": 4, \"1\": \"负载平衡\", \"title\": \"一个或多个核将自己的部分和结果发送给其他的核这一过程称之为：（）\", \"3\": \"异步\", \"0\": \"通信\", \"2\": \"同步\"}','A',''),
	(273,0,'{\"title\": \"如果一个进程试图接收消息，但没有相匹配的消息，那么该进程将会被永远阻塞在那里,这种情况叫做( )\", \"len\": 3, \"1\": \"进程阻\", \"0\": \"进程悬挂\", \"2\": \"进程死锁\"}','A',''),
	(274,0,'{\"title\": \"如果程序可以在不增加问题规模的前提下维持恒定效率，那么程序拥有( )  扩展性\", \"len\": 2, \"1\": \"强\", \"0\": \"弱\"}','B',''),
	(275,0,'{\"title\": \"在一个集合通信中，如果属于一个进程的数据被发送到通信子中的所有进程，则这样的集合通信叫做 ( )\", \"len\": 3, \"1\": \"集合通信\", \"0\": \"点对点通信\", \"2\": \"广播\"}','C',''),
	(276,0,'{\"title\": \"串行时间与并行时间的比值叫做\", \"len\": 2, \"1\": \"加速比\", \"0\": \"效率\"}','B',''),
	(277,0,'{\"len\": 4, \"1\": \"barrier\", \"title\": \"在并行域当中，有一段代码想用单线程执行，是使用什么关键字\", \"3\": \"master\", \"0\": \"single\", \"2\": \"atomic\"}','A',''),
	(278,0,'{\"title\": \"在任何一个 MIMD 系统中，如果处理器异步执行，那么很可能会引发（ ）。\", \"len\": 3, \"1\": \"弱确定性\", \"0\": \"强确定性\", \"2\": \"非确定性\"}','C',''),
	(279,0,'{\"len\": 4, \"1\": \"锁有两个操作，分别是获取锁和释放锁\", \"title\": \"对于锁，以下表述不正确的是：( )\", \"3\": \"若线程不主动放弃锁，其他线程可以抢占它\", \"0\": \"锁类似于信号量，不同之处在于在同一时刻只能使用一个锁。\", \"2\": \"互斥量是一种锁，线程对共享资源进行访问之前必须先获得锁；否则线程将保持等待状态，直到该锁可用。\"}','D',''),
	(280,0,'{\"len\": 4, \"1\": \"在引入线程的操作系统中，则把线程作为 CPU  调度和分派的基本单位\", \"title\": \"以下表述不正确的是：( )\", \"3\": \"由一个进程中的线程切换到另一进程中的线程时，也不会引起进程切换\", \"0\": \"在传统的操作系统中，CPU  调度和分派的基本单位是进程\", \"2\": \"同一进程中线程的切换不会引起进程切换，从而避免了昂贵的系统调用\"}','D',''),
	(281,0,'{\"len\": 4, \"1\": \"除非你已经有了一个相当清晰可靠的非优化版本的实现，否则你不要试图对程序进行优化\", \"title\": \"Jackson  优化定律是指：( )\", \"3\": \"以上两条都不是\", \"0\": \"不要进行优化\", \"2\": \"以上两条都是\"}','C',''),
	(282,0,'{\"len\": 4, \"1\": \"线程是 CPU 调度和分派的基本单位\", \"title\": \"关于进程和线程的描述中不正确的是\", \"3\": \"线程必须依存在进程中，由进程提供多个线程执行的控制\", \"0\": \"进程和线程都可以独立执行\", \"2\": \"进程是系统进行资源分配和调度的一个独立单位\"}','A',''),
	(283,0,'{\"len\": 4, \"1\": \"4\", \"title\": \"How many threads per core on Xeon Phi?\", \"3\": \"8\", \"0\": \"2\", \"2\": \"6\"}','B',''),
	(284,0,'{\"title\": \"What\'s the purpose of huge page setting on Xeon Phi?\", \"len\": 3, \"1\": \"Improve memory bandwidth\", \"0\": \"Improve TLB hit ratio.\", \"2\": \"Improve data locality\"}','A',''),
	(285,0,'{\"len\": 4, \"1\": \"512bits\", \"title\": \"How long is vector length on Xeon Phi?\", \"3\": \"64bits\", \"0\": \"128bits\", \"2\": \"256bits\"}','B',''),
	(286,1,'{\"len\": 6, \"1\": \"执行终止\", \"title\": \"作为多遍优化算法 PGO 的三步过程由以下哪三步构成？( )\", \"5\": \"代码执行与评估\", \"3\": \"执行被插入信息采集代码的程序(Instrumented execution)\", \"4\": \"插入信息采集代码后编译(Instrumented compilation)\", \"0\": \"代码编译\", \"2\": \"反馈编译（feedback compilation）\"}','C;D',''),
	(287,1,'{\"len\": 4, \"1\": \"concurrent_queue\", \"title\": \"以下属于 TBB 中的并行容器的是：( )\", \"3\": \"concurrent_vector\", \"0\": \"concurrent_set\", \"2\": \"concurrent_hash_map\"}','B;C;D',''),
	...
	(289,1,'{\"title\": \"避免对临界区竞争访问的基本方法有 ()\", \"len\": 3, \"1\": \"互斥量\", \"0\": \"忙等待\", \"2\": \"信号量\"}','A;B;C',''),
	(290,1,'{\"len\": 4, \"1\": \"合并\", \"title\": \"如果进程是执行的“主线程”，其他线程由主线程启动和停止，那么我们可以设想进程和它的子线程如 下进行，当一个线程开始时，它从进程中（ ）出来；当一个线程结束，它（ ）到进程中。\", \"3\": \"消亡\", \"0\": \"派生\", \"2\": \"分离\"}','A;B',''),
	(291,1,'{\"title\": \"下面是 MPI 可以绑定的语言的是( )\", \"len\": 3, \"1\": \"C++语言\", \"0\": \"C 语言\", \"2\": \"Fortran  语言\"}','A;B;C',''),
	(292,1,'{\"len\": 4, \"1\": \"随机取样\", \"title\": \"VTune  性能分析器中的取样功能有哪几种方式？()\", \"3\": \"线性取样\", \"0\": \"基于时间取样\", \"2\": \"基于事件取样\"}','A;C',''),
	(293,1,'{\"len\": 4, \"1\": \"使用原子操作来替代锁。\", \"title\": \"对于如何解决串行化方面的难题，以下表述正确的是：()\", \"3\": \"设计并行指令\", \"0\": \"少用锁，甚至采用无锁编程。\", \"2\": \"从设计和算法层面来缩小串行化所占的比例。\"}','A;B;C',''),
	(294,1,'{\"title\": \"下面是 MPI 提供的拓扑是 ( )\", \"len\": 2, \"1\": \"图拓扑\", \"0\": \"笛卡儿拓扑\"}','A;B',''),
	(756,3,'下列函数将一个数组A变换成另一个数组B，A和B的元素数量相同、且![](/static/upload/mdimages/20161228163737.png)。数组A和数组B已预先划分成若干个等长片段，每个片段的大小为size，第k个片段存储在通信子\\*comm的第k号进程上。在每个处理器上，数组A的本地片段的存储空间起始地址为函数参数”A”、 数组B的本地片段的存储空间起始地址为函数参数”B”。请补充缺少的代码。\r\n\r\n```\r\nvoid mysum(MPIComm *comm, int *A, int *B, int size) {\r\n	int i, rank, np, *sum;\r\n	MPICommsize(*comm, &np);\r\n	MPICommrank(*comm, &rank);	\r\n	B[0] = A[0];\r\n	for(i=1; i<size; i++) B[i] = B[i-1] + A[i];\r\n	sum = new int[np];\r\n	MPIAllgather(&B[size-1], 1, MPIINT, sum, 1, MPIINT, *comm);\r\n	*sum[rank] = 0;for(i=0; i<rank; i++) sum[rank] += sum[i];for(i=0; i<size; i++) B[i] += sum[rank]; *\r\n	delete[] sum;	\r\n}\r\n```\r\n','{\"0\":\"comm的第k号进程上。在每个处理器上，数组A的本地片段的存储空间起始地址为函数参数”A”、 数组B的本地片段的存储空间起始地址为函数参数”B”。请补充缺少的代码。\\n\\n```\\nvoid mysum(MPIComm \",\"1\":\"A, int \",\"2\":\"sum;\\n\\tMPICommsize(\",\"3\":\"comm, &rank);\\t\\n\\tB[0] = A[0];\\n\\tfor(i=1; i<size; i++) B[i] = B[i-1] + A[i];\\n\\tsum = new int[np];\\n\\tMPIAllgather(&B[size-1], 1, MPIINT, sum, 1, MPIINT, \",\"4\":\"sum[rank] = 0;for(i=0; i<rank; i++) sum[rank] += sum[i];for(i=0; i<size; i++) B[i] += sum[rank]; \",\"len\":5}',''),
	...
	(759,3,'下列函数实现数组元素求和：数组的大小为array_size，其元素全部存储在通信子\\*comm的第root号进程上，array是数组的起始地址，计算结果也返回给第root号进程。请补充缺少的代码。\r\n\r\n```\r\n#define SIZE       20 \r\n#define NOTASK     1\r\n#define NEWTASK    2  \r\nint my_sum(MPI_Comm* comm, int *array, int array_size, int root) {\r\n	MPI_Status  status;\r\n	int rank, i, size, data[SIZE], val=0;\r\n	MPI_Comm_rank(*comm, &rank);	\r\n	if ( rank==root ) {\r\n		*缺少的代码*\r\n	}\r\n	else while(1) {\r\n		MPI_Send(&val, 1, MPI_INT, root, 0, *comm);\r\n		MPI_Recv(data, SIZE, MPI_INT, root, MPI_ANY_TAG, *comm, &status);\r\n		if (status.MPI_TAG==NOTASK) break;\r\n		val = 0;\r\n		MPI_Get_count(&status, MPI_INT, &size);\r\n		for(i=0; i<size; i++) val += data[i];\r\n	}	\r\n}\r\n```','{\"0\":\"comm的第root号进程上，array是数组的起始地址，计算结果也返回给第root号进程。请补充缺少的代码。\\n\\n```\\n#define SIZE       20 \\n#define NOTASK     1\\n#define NEWTASK    2  \\nint my_sum(MPI_Comm\",\"1\":\"array, int array_size, int root) {\\n\\tMPI_Status  status;\\n\\tint rank, i, size, data[SIZE], val=0;\\n\\tMPI_Comm_rank(\",\"2\":\"缺少的代码\",\"3\":\"comm);\\n\\t\\tMPI_Recv(data, SIZE, MPI_INT, root, MPI_ANY_TAG, \",\"len\":4}',''),
	(760,5,'在有24颗执行核的SMP/多核处理器系统上，对二维矩阵A进行2D5P模板计算，假设A的规模为2m2n，m>n>5。请设计一个并行求解算法并给出该算法的加速比上限。','',''),
	(761,5,'A和B是两个单精度浮点数的矩阵，A的规模为n×m、B的规模为m×k。请问，在CUDA上实现矩阵乘法A×B时，GPU与设备内存之间的最少数据交换量为多少？假设执行配置中，线程块的笛卡尔结构为r×c。','',''),
	(762,5,'矩阵A的规模是2^m×2^n、矩阵B的规模是2^n×2^k。在一个由2^2p颗处理器构成的BSP上，采用流水并行执行A×B。假设m、n、k均大于p。\r\n\r\na)	每颗处理上消耗的存储空间规模是多少？\r\n\r\nb)	要执行多少个超级计算步？\r\n\r\nc)	在计算过程中，每颗处理器总共要发送多少个数据元素？ ','',''),
	(763,5,'一个无权图G的顶点数量为n、半径为α、直径为β。在一个APRAM-CRCW并行计算机上以最快速度执行BFS，请问并行计算效率的上限和下限分别是多少？假设在该APRAM-CRCW并行计算机上，一个操作内可以完成两项计算：某个顶点的状态更新计算；比较当前顶点被更新前后的状态值并将比较结果写入并行计算机的存储空间。','',''),
	(764,5,'在一个由p颗处理器构成的BSP上将数组A变换成数组B，A和B都有n个元素，B的每个元素 Bi 的值是![](/static/upload/md_images/20161229234518.png)。假设p远小于n，设计一个并行求解算法并给出该算法的加速比上限。','',''),
	(765,5,'在一台BSP并行计算机上，共有p颗处理器。请问：为尽可能快的完成两个长度为N的向量的点积运算，共需要执行多少个超级计算步、并简述计算超级计算步数量的依据。假设N远大于p。','',''),
	(766,5,'在p颗处理器的PRAM并行计算机上对N个元素求和。请问加速比和并行计算效率分别是多少？','',''),
	(767,5,'一个N-body问题中包括2^n个粒子。在一个由2^p颗处理器构成的BSP上采用分治并行计算粒子的受力，在一个时间步上要经过多少个超级计算步才能计算出一个粒子的受力？假设n大于p。','',''),
	...
	(770,5,'假设A和B是两个向量，各存储N个复数。请问执行A和B的向量乘(A的第I个元素与B的第I个元素相乘)，至少需要多少次乘法运算?','','');
...
VALUES
	...
	(17,4,1,'','C','2016-12-24 13:53:19',NULL),
...
INSERT INTO `users` (`id`, `username`, `password_hash`, `email`, `is_password_reset_link_valid`, `last_login`, `date_joined`, `website`, `avatar_url`, `permissions`, `personal_id`, `personal_profile`, `telephone`, `topicNum`, `postNum`, `commentNum`, `open_id`)
VALUES
	(1,'root','pbkdf2:sha1:1000$xBnOyGu0$2265b81c262f0438d80348748b24db1f66a65425','1291023320@qq.com',0,'2016-12-30 13:47:52','2016-09-29 03:14:30','http://selfboot.cn','/static/upload/1.png?t=1475844478.0',1,NULL,'知其然，知其所以然。知识广度是深度的副产品！',NULL,4,1,3,NULL),
	(2,'test','pbkdf2:sha1:1000$JZE0rscV$a7b07ad8602a608e76dc583142b1aaf2c378c55b','1@qq.com',0,'2016-12-30 09:17:28','2016-09-29 03:35:29',NULL,'http://www.gravatar.com/avatar/',1,NULL,'好好学习，天天向上',NULL,0,0,1,NULL),
	(3,'teacher','pbkdf2:sha1:1000$ZRqJzJuR$ec4e50db6eb3eaae92e7cb8bd9468fd2743c3505','teacher@qq.com',0,'2017-01-04 13:45:04','2016-09-29 03:36:08','http://a','/static/upload/3.png?t=1477293245.0',2,NULL,'混吃等死不舒服',NULL,0,1,5,NULL),
	(4,'abc','pbkdf2:sha1:1000$Z0hb47ZO$8cc84309e6a696c6deb28d6ebb910fa828d16e3d','3@qq.com',0,'2016-10-23 10:40:03','2016-10-17 03:00:38',NULL,'http://www.gravatar.com/avatar/',1,NULL,NULL,NULL,1,2,0,NULL),
	(5,'admin','pbkdf2:sha1:1000$h9IWWCJh$78e5c725ab15124732c7b19dbe43775df4e823e1','admin@qq.com',0,'2017-01-02 18:50:50','2016-10-22 11:41:15',NULL,'http://www.gravatar.com/avatar/',0,NULL,NULL,NULL,0,0,0,NULL),
	(6,'wudi','pbkdf2:sha1:1000$Qk7DY2fe$1a4a67c484525536c1abbe395bd8b5861d7ace37','wudi27@mail.sysu.edu.cn',0,'2016-10-18 11:13:55','2016-10-18 02:57:55',NULL,'http://www.gravatar.com/avatar/',1,NULL,NULL,NULL,1,1,0,NULL),
	(7,'yongyi_yang','pbkdf2:sha1:1000$qeUp02pL$088fe9b296a054b622d5b3826045d9c7dbd28e9c','18826073128@163.com',0,'2016-12-15 12:03:44','2016-10-18 15:03:29',NULL,'http://www.gravatar.com/avatar/',1,NULL,NULL,NULL,2,0,0,NULL),
	(8,'alexhanbing','pbkdf2:sha1:1000$MsiV0RcE$b9d0794fd92ce0f1d6c3432f4a68614ec60294ca','565613352@qq.com',0,'2016-10-21 14:18:52','2016-10-21 14:18:52',NULL,NULL,1,NULL,NULL,NULL,0,3,0,NULL),
	(9,'forest80','pbkdf2:sha1:1000$34jYf26A$3f6f628bd4e48ed8492219171920e9d498d5023b','forest80@163.com',1,'2016-12-05 14:04:15','2016-12-05 14:04:15',NULL,'http://www.gravatar.com/avatar/',1,NULL,NULL,NULL,0,0,0,NULL),
	(10,'Zouzhp','pbkdf2:sha1:1000$fzjFGAmb$30667cca608819c147c04d5a49671989dd66cefd','503951764@qq.com',1,'2017-01-01 21:05:51','2016-12-12 10:22:07',NULL,'/static/upload/10.png?t=1481509362.88',1,NULL,NULL,NULL,0,0,0,NULL),
	(11,'test1','pbkdf2:sha1:1000$3fdjJ0du$b93a90b23e1365bd53962cf7339ff69d7c6e0423','test@163.com',1,'2016-12-15 12:15:14','2016-12-15 12:15:14',NULL,'http://www.gravatar.com/avatar/',1,NULL,NULL,NULL,0,0,0,NULL),
	(12,'test_nscc','pbkdf2:sha1:1000$ANtf20qe$a3f467c203a80abde2b126307f04af5affb50164','lijianggs@126.com',1,'2017-01-03 15:14:08','2017-01-03 15:14:08',NULL,'http://www.gravatar.com/avatar/',1,NULL,NULL,NULL,0,0,0,NULL);
